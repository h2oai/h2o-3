...
public class DHistogramTest extends TestUtil {
  ...
  public void initCachesZeroPosition() {
    ...
    try {
      ...
      DHistogram histo = new DHistogram("test", 20, 1024, (byte) 1, -1, 2, (byte) 0, false, -0.001,
  ...
  public void randomSplitPointsAreConsistent() {
    ...
    try {
      ...
      DHistogram histoRand = new DHistogram("rand", 20, 1024, (byte) 0, min, maxEx, (byte) 0, false, -0.001,
      ...
      DKV.put(hq);
      Scope.track_generic(hq);
      DHistogram histoQuant = new DHistogram("quant", 20, 1024, (byte) 0, min, maxEx, (byte) 0, false, -0.001,
              SharedTreeModel.SharedTreeParameters.HistogramType.QuantilesGlobal, 42L, hq._key, null);
      histoQuant.init();
