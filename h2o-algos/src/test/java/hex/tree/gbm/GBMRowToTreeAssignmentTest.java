...
public class GBMRowToTreeAssignmentTest extends TestUtil {
    ...
    public void testRowToTreeAssignmentSmokeBinomialHardcoded() {
        ...
        try {
            ...
            parms._enable_row_to_tree_assignment = true;
            ...
            Frame rowToTreeAssignmentActual = DKV.getGet(model._output._row_to_tree_assignment);
    ...
    public void testRowToTreeAssignmentSmokeRegressionAndMultinomialHardcoded() {
        ...
        try {
            ...
            Frame rowToTreeAssignmentActualReg = DKV.getGet(modelReg._output._row_to_tree_assignment);
            ...
            Frame rowToTreeAssignmentActualMult = DKV.getGet(modelMult._output._row_to_tree_assignment);
...
//            train.toCategoricalCol(response);
    ...
    private void checkRowToTreeAssignment(GBMModel model, Frame train, String response) {
        Frame rowToTreeAssignment = DKV.getGet(model._output._row_to_tree_assignment);
