...
public class HistogramTest extends TestUtil {
  ...
  @Test public void testSplits() {
    ...
    for (SharedTreeModel.SharedTreeParameters.HistogramType histoType : SharedTreeModel.SharedTreeParameters.HistogramType.values()) {
      ...
      DHistogram hist = new DHistogram("myhisto",nbins,nbins_cats,isInt,min,maxEx, (byte) 0,false,0,histoType,seed,k,null);
      hist.init();
      int N=10000000;
      int bin=-1;
  ...
  @Test public void testUniformAdaptiveRange() {
    ...
    DHistogram hist = new DHistogram("myhisto", nbins, nbins_cats, isInt, min, maxEx, (byte) 0,false, 0, histoType, seed, null, null);
    hist.init();
