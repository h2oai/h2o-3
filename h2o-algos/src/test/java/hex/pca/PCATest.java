...
public class PCATest extends TestUtil {
    ...
    try {
      for (DataInfo.TransformType std : new DataInfo.TransformType[] {
        ...
        try {
          ...
          parms._method = PCAParameters.Method.Power;
          ...
          if( model != null ) {
            if (model._parms._keep_loading && model._parms._method == PCAParameters.Method.Power)
  ...
  @Test public void testArrestsScoring() throws InterruptedException, ExecutionException {
    ...
    try {
      ...
      parms._method = PCAParameters.Method.GramSVD;
