...
public class GamMojoModelTest {
  ...
  public void testNaN() {
    Scope.enter();
    try {
      final Frame fr = Scope.track(createTranFrameWithNaNs());
  ...
  public void testBinomialPredMojo() {
    ...
    try {
      // test for binomial
      String[] ignoredCols = new String[]{"C3", "C4", "C5", "C6", "C7", "C8", "C9", "C10", "C13", "C14",
  ...
  public void testGaussianPredMojo() {
    Scope.enter();
    try {
      String[] ignoredCols = new String[]{"C3", "C4", "C5", "C6", "C7", "C8", "C9", "C10", "C14",
              "C15", "C16", "C17", "C18", "C19", "C20"};
  ...
  public void testMultinomialModelMojo() {
    ...
    try {
      // multinomial
      String[] ignoredCols = new String[]{"C3", "C4", "C5", "C9", "C10"};
  ...
  private Frame createTranFrameWithNaNs() {
