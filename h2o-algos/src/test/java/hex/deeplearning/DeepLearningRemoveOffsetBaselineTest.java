 ...
 *
 * NOTE: this class only pins the flag=false path. The flag=true behaviour (and the mean(response) bias that
 * a naive zero-offset scoring would introduce) lives in DeepLearningRemoveOffsetEffectTest.
 */
