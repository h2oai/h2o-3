...
//    System.out.println("made copy of vec " + v._key + " -> " + v2._key + ", in DKV? src =" + ((DKV.get(v._key) != null)) + ", dst = " + (DKV.get(v2._key) != null));
  ...
  public void testSparse() {
    ...
    for (Family family : new Family[]{Family.gaussian, Family.AUTO}) {
      for (GLMParameters.Link link : new GLMParameters.Link[]{GLMParameters.Link.family_default, GLMParameters.Link.identity}) {
        GLMParameters parms = new GLMParameters(family, link);
  ...
  @Test public void  testWeights() {
    ...
    for (Family family : new Family[]{Family.gaussian, Family.AUTO}) {
      GLMParameters parms = new GLMParameters(family);
