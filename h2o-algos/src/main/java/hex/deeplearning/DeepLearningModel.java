...
//      return false;
  ...
  public Frame scoreDeepFeatures(Frame frame, final int layer) {
    ...
    Scope.enter();
    adaptTestForTrain(_output._names, _output.weightsName(), _output.offsetName(), null /*don't skip response*/, _output._domains, adaptFrm, _parms.missingColumnsType(), true);
