...
import static hex.genmodel.algos.isoforfaircut.FairCutForestMojoModel.anomalyScore;

public class FairCutForestModel extends Model<FairCutForestModel, FairCutForestModel.FairCutForestParameters,
        FairCutForestModel.FairCutForestOutput> {
    private static final Logger LOG = Logger.getLogger(FairCutForestModel.class);

    public FairCutForestModel(Key<FairCutForestModel> selfKey, FairCutForestParameters parms,
                              FairCutForestOutput output) {
        super(selfKey, parms, output);
    }

    @Override
    public ModelMetrics.MetricBuilder makeMetricBuilder(String[] domain) {
        return new ModelMetricsAnomaly.MetricBuilderAnomaly("FairCutForest Metrics", false);
    }
    ...
    public static class FairCutForestParameters extends Model.Parameters {

        @Override
        public String algoName() {
            return "FairCutForest";
        }

        @Override
        public String fullName() {
            return "Fair Cut Forest";
        }

        @Override
        public String javaName() {
            return FairCutForestModel.class.getName();
        }
        ...
        /**
         * Number of generated hyperplanes in each step.
         */
        public int _k_planes;

        public FairCutForestParameters() {
            super();
            _ntrees = 100;
            _sample_size = 256;
            _extension_level = 0;
    ...
    public static class FairCutForestOutput extends Model.Output {
        ...
        public FairCutForestOutput(FairCutForest f) {
            super(f);
            _ntrees = f._parms._ntrees;
            _sample_size = f._parms._sample_size;
        }
    ...
    @Override
    public FairCutForestMojoWriter getMojo() {
        return new FairCutForestMojoWriter(this);
    }
}
