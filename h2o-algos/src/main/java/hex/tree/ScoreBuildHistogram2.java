...
public class ScoreBuildHistogram2 extends ScoreBuildHistogram {
  ...
  public ScoreBuildHistogram2(ScoreBuildOneTree sb, int k, int ncols, int nbins, int nbins_cats, DTree tree, int leaf, DHistogram[][] hcs, DistributionFamily family, 
                              int respIdx, int weightIdx, int predsIdx, int workIdx, int nidIdxs) {
    super(sb, k, ncols, nbins, nbins_cats, tree, leaf, hcs, family, weightIdx, workIdx, nidIdxs);
