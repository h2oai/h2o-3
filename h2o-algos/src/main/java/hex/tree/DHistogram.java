...
//              Log.info("Refined splitPoints: " + Arrays.toString(_splitPts));
  ...
  public void setToDiff( DHistogram a, DHistogram b ) {
    ...
    assert (_w == null && a._w == null) || (_w != null && a._w != null);
    assert (_w == null && b._w == null) || (_w != null && b._w != null);
    assert ( a._w != null );
...
//      Log.info("Not splitting: split would violate min_rows limit:\n" + this);
  ...
  public void updateSharedHistosAndReset(ScoreBuildHistogram.LocalHisto lh, double[] ws, double[] cs, double[] ys, int [] rows, int hi, int lo) {
    ...
    for(int r = lo; r< hi; ++r) {
      ...
      if (_histoType != SharedTreeModel.SharedTreeParameters.HistogramType.Uniform) {
