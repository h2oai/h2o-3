  ...
  public class CoxPHDriver extends H2O.H2OCountedCompleter<CoxPHDriver> {
    ...
    @Override protected void compute2() {
      ...
      try {
        ...
        final DataInfo dinfo = new DataInfo(Key.make(), _modelBuilderTrain, null, nResponses, useAllFactorLevels, DataInfo.TransformType.DEMEAN, TransformType.NONE, true, 0 /*no row weights*/);
