...
public class SVMModel extends Model<SVMModel, SVMModel.SVMParameters, SVMModel.SVMModelOutput> {

  private transient SupportVectorScorer _scorer; // initialized lazily

  public SVMModel(Key<SVMModel> selfKey, SVMModel.SVMParameters params, SVMModel.SVMModelOutput output) {
  ...
  public static class SVMParameters extends Model.Parameters {
    ...
    public String fullName() { return "SVM"; }
  ...
  public static class SVMModelOutput extends Model.Output {
    ...
    SVMModelOutput(SVM b, Frame f, String[] respDomain) { 
      super(b, f);
