 ...
 * @param <T>
 */
public class MetricBuilderSVM<T extends MetricBuilderSVM<T>> extends ModelMetricsSupervised.MetricBuilderSupervised<T> {
  protected AUC2.AUCBuilder _auc;

  public MetricBuilderSVM(String[] domain) {
    super(2, domain);
