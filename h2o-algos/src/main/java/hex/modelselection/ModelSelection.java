...
public class ModelSelection extends ModelBuilder<hex.modelselection.ModelSelectionModel, hex.modelselection.ModelSelectionModel.ModelSelectionParameters, hex.modelselection.ModelSelectionModel.ModelSelectionModelOutput> {
    ...
    public class ModelSelectionDriver extends Driver {
            ...
            for (int predNum = 1; predNum <= _parms._max_predictor_number; predNum++) { // find best predictor subset for each subset size
                ...
                if (bestModel == null) {
                    bestModel = forwardStep(currSubsetIndices, predNames, validSubset,
                            usedCombos, _crossProductMatrix, _predictorIndex2CPMIndices, null, _parms._intercept);
                } else {
                    if (_parms._build_glm_model)
                        genBestSweepVector(bestModel, _crossProductMatrix, _predictorIndex2CPMIndices, _parms._intercept);
                    bestModel = forwardStep(currSubsetIndices, predNames, validSubset,
                            usedCombos, _crossProductMatrix, _predictorIndex2CPMIndices, bestModel, _parms._intercept);
                }
        ...
        public SweepModel forwardStep(List<Integer> currSubsetIndices, List<String> coefNames,
        ...
        public SweepModel replacement(List<Integer> currSubsetIndices, List<String> coefNames, List<Integer> validSubset,
            ...
            while (true) {  // loop to find better predictor subset via sequential replacement
                for (int index = 0; index < currSubsetSize; index++) {
                        ...
                        genBestSweepVector(currModel, _crossProductMatrix, _predictorIndex2CPMIndices, _parms._intercept);
                        tempModel = forwardStep(oneLessSubset, coefNames, validSubset, usedCombos,
                                _crossProductMatrix, _predictorIndex2CPMIndices, currModel, _parms._intercept);
        ...
        void buildMaxRModels(ModelSelectionModel model) {
            ...
            for (int predNum = 1; predNum <= _parms._max_predictor_number; predNum++) { // perform for each subset size
                Set<BitSet> usedCombos = new HashSet<>();
                GLMModel bestR2Model = forwardStepMaxR(currSubsetIndices, coefNames, predNum - 1, validSubset,
                ...
                if (predNum < _numPredictors && predNum > 1) {
                    ...
                    GLMModel currBestR2Model = replacementMaxR(currSubsetIndices, coefNames, bestR2ofModel, _parms,
     ...
     */
    public static GLMModel forwardStepMaxR(List<Integer> currSubsetIndices, List<String> coefNames, int predPos, 
...
*//*                    currSubsetIndices.clear();
    ...
    public static GLMModel forwardStepMaxR(List<Integer> currSubsetIndices, List<String> coefNames, int predPos,
        ...
        return forwardStepMaxR(currSubsetIndices, coefNames, predPos, validSubsets, parms, foldColumn, glmNFolds, 
                foldAssignment, null);
    }
     ...
     *
     */
    public static GLMModel replacementMaxR(List<Integer> currSubsetIndices, List<String> coefNames,
        ...
        while (true) {
            for (int index = 0; index < currSubsetSize; index++) {  // go through all predictor position in subset
                ...
                oneModel = forwardStepMaxR(oneLessSubset, coefNames, index, validSubset, parms,
