...
//        beta[beta.length-1] = this.beta[this.beta.length-1];
  ...
  public static class GLMOutput extends Model.Output {
    ...
    public double lambda_best(){return _submodels.length == 0 ? Double.NaN : _submodels[_best_lambda_idx].lambda_value;}
    public double lambda_1se(){return _lambda_1se == -1?-1:_submodels.length == 0 ? Double.NaN : _submodels[_lambda_1se].lambda_value;}
    public double lambda_selected(){return _submodels.length == 0 ? Double.NaN : _submodels[_selected_lambda_idx].lambda_value;}
    double[] _global_beta;
