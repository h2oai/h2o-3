...
public class GLMModel extends Model<GLMModel,GLMModel.GLMParameters,GLMModel.GLMOutput> {
  ...
  public static class GLMParameters extends Model.Parameters {
    ...
    public void validate(GLM glm) {
      ...
      if (_solver.equals(Solver.IRLSM_NATIVE) && !_family.equals(Family.multinomial))
        glm.error("IRLSM_NATIVE", "is only available for the multinomial family.");
...
//        case multinomial: // should not be used
    ...
    public static enum Solver {AUTO, IRLSM, P_TEST, IRLSM_NATIVE, IRLSM_SPEEDUP_TEST, L_BFGS, COORDINATE_DESCENT_NAIVE,
