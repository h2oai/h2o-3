...
//        beta[beta.length-1] = this.beta[this.beta.length-1];
  ...
  public static class GLMOutput extends Model.Output {
    ...
    public double lambda_best() {
      return _submodels.length == 0 ? -1 : _submodels[_best_submodel_idx].lambda_value;
    }
    ...
    public boolean dispersionEstimated() {
      return _dispersionEstimated;
    }

    public double alpha_best() {
      return _submodels.length == 0 ? -1 : _submodels[_selected_submodel_idx].alpha_value;
    }
    ...
    public boolean hasPValues() {
      return _zvalues != null;
    }

    public boolean hasVIF() {
      return _vif_predictor_names != null;
    }
    ...
    public double[] getVariableInflationFactors() {
      return _variable_inflation_factors;
    }

    public String[] getVIFPredictorNames() {
      return _vif_predictor_names;
    }
    ...
    public int rank() {
      return _submodels[_selected_submodel_idx].rank();
    }
    ...
    public String[] randomcoefficientNames() {
      return _random_coefficient_names;
    }
    ...
    public InteractionBuilder interactionBuilder() {
      return _dinfo._interactionSpec != null ? new GLMInteractionBuilder() : null;
    }
    ...
    public double[][] get_global_beta_multinomial() {
      return _global_beta_multinomial;
    }
  ...
  protected boolean needsPostProcess() {
    return false; /* pred[0] is already set by score0 */
  }
