...
public final class ComputationState {
  ...
  public void update2ndDerivatives(ConstraintsGram[] constraintDerivatives, LinearConstraints[] constraints) {
    int numConst = constraints.length;
    for (int index=0; index<numConst; index++)
      constraintDerivatives[index]._active = constraints[index]._active;
  }
  
  public void updateDerivatives(ConstraintsDerivatives[] constraintDerivatives, LinearConstraints[] constraints) {
    int numConst = constraints.length;
    for (int index=0; index<numConst; index++) {
       constraintDerivatives[index]._active = constraints[index]._active;
    }
