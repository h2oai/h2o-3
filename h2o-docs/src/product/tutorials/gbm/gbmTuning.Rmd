...
install.packages("h2o", type="source", repos=(c("http://h2o-release.s3.amazonaws.com/h2o/rel-turchin/7/R")))
```
...
1            0.61                             1.01                     0.65 QuantilesGlobal        27        8
2               1                             0.96                     0.88      RoundRobin        26        1
3            0.45                             1.01                     0.92 QuantilesGlobal        20       16
4            0.85                             0.91                     0.98      RoundRobin        25        2
5            0.67                             0.96                     0.95 QuantilesGlobal        29        2
  min_split_improvement nbins nbins_cats sample_rate            model_ids               auc
1                 1e-06    64         64         0.9 final_grid_model_145 0.972471118624965
2                 1e-06    16        256        0.62  final_grid_model_77 0.971907579599887
3                 1e-06    64        128           1 final_grid_model_207 0.971513102282333
4                 1e-06   256         16        0.84 final_grid_model_199  0.97083685545224
5                     0   128         64        0.56 final_grid_model_126 0.970498732037194
```
...
F0point5                  0.9332861  0.017168146      0.9375   0.9259259  0.89215684   0.9655172  0.9453303
F1                        0.9071058  0.010241188   0.9056604   0.8888889  0.90547264  0.93333334 0.90217394
F2                        0.8831634  0.017258307   0.8759124  0.85470086   0.9191919   0.9032258  0.8627859
accuracy                  0.9321815 0.0073897345  0.92509365  0.92619926   0.9263566   0.9527559 0.93050194
auc                      0.96554846 0.0047372826      0.9625   0.9585417  0.97206634  0.97497517  0.9596591
err                      0.06781854 0.0073897345 0.074906364 0.073800735  0.07364341 0.047244094 0.06949807
err_count                      17.8     2.116601          20          20          19          12         18
lift_top_group            2.6258688  0.099894695   2.3839285   2.8229167    2.632653   2.6736841  2.6161616
logloss                  0.21281372  0.011134119  0.22524613  0.22729652  0.20088919      0.1877 0.22293678
max_per_class_error       0.1323859   0.02389102  0.14285715  0.16666667       0.075  0.11578947 0.16161616
mcc                        0.857329  0.015623019   0.8476048   0.8381745  0.84591836   0.9002499  0.8546976
mean_per_class_accuracy   0.9199189  0.008318729   0.9156682   0.9052381   0.9267857   0.9389606 0.91294193
mean_per_class_error     0.08008109  0.008318729 0.084331796  0.09476191 0.073214285 0.061039392 0.08705808
mse                     0.059890654 0.0039929743 0.063487545 0.064152025  0.05727426 0.049929507 0.06460994
precision                 0.9521164  0.025824018        0.96  0.95238096  0.88349515   0.9882353  0.9764706
r2                       0.74576706  0.017048854  0.73928785   0.7195602    0.756862   0.7867426  0.7263826
recall                    0.8683284  0.024754621  0.85714287   0.8333333   0.9285714   0.8842105 0.83838385
specificity               0.9715094  0.017177489   0.9741936   0.9771429       0.925   0.9937107     0.9875
```

Ouch! So it looks like we overfit quite a bit on the validation set as the mean AUC on the 5 folds is "only" 96.55% +/- 0.5%. So we cannot always expect AUCs of 97% with these parameters on this dataset. So to get a better estimate of model performance, the Random hyper-parameter search could have used `nfolds = 5` (or 10, or similar) in combination with 80% of the data for training (i.e., not holding out a validation set, but only the final test set). However, this would take more time, as `nfolds+1` models will be built for every set of parameters.
...
Cross-Validation Metrics Summary: 
          mean          sd cv_1_valid cv_2_valid cv_3_valid cv_4_valid cv_5_valid
auc 0.96247756 0.005011182  0.9667051 0.94866073 0.96288264 0.96703076  0.9671086
[1] "final_grid_model_207"
Cross-Validation Metrics Summary: 
         mean          sd cv_1_valid cv_2_valid cv_3_valid cv_4_valid cv_5_valid
auc 0.9644667 0.004932883  0.9628456  0.9593155 0.96572065 0.97715986 0.95729166
[1] "final_grid_model_199"
Cross-Validation Metrics Summary: 
          mean           sd cv_1_valid cv_2_valid cv_3_valid cv_4_valid cv_5_valid
auc 0.96556675 0.0042707943  0.9612327  0.9558036  0.9705995 0.97106916  0.9691288
[1] "final_grid_model_126"
Cross-Validation Metrics Summary: 
         mean           sd cv_1_valid cv_2_valid cv_3_valid cv_4_valid cv_5_valid
auc 0.9623292 0.0042713513 0.96209675  0.9618155   0.967602  0.9685535 0.95157826
```
...
> head(preds)
  predict         p0         p1
1       0 0.98559757 0.01440243
2       0 0.98579870 0.01420130
3       0 0.74888537 0.25111463
4       1 0.01307454 0.98692546
5       1 0.01073186 0.98926814
6       0 0.81400200 0.18599800

> gbm@model$validation_metrics@metrics$max_criteria_and_metric_scores
Maximum Metrics: Maximum metrics at their respective thresholds
                        metric threshold    value idx
1                       max f1  0.595966 0.934673  93
2                       max f2  0.290259 0.924528 109
3                 max f0point5  0.595966 0.966736  93
4                 max accuracy  0.595966 0.952555  93
5                max precision  0.989814 1.000000   0
6                   max recall  0.013050 1.000000 262
7              max specificity  0.989814 1.000000   0
8             max absolute_MCC  0.595966 0.900991  93
9   max min_per_class_accuracy  0.290259 0.928994 109
10 max mean_per_class_accuracy  0.595966 0.939899  93
```
...
/*
  ...
  AUTOGENERATED BY H2O at 2016-06-02T16:22:13.828-07:00
  3.9.1.99999
  
  Standalone prediction code with sample test data for GBMModel named final_grid_model_145

  How to download, compile and execute:
      mkdir tmpdir
      cd tmpdir
      curl http://172.16.2.75:54321/3/h2o-genmodel.jar > h2o-genmodel.jar
      curl http://172.16.2.75:54321/3/Models.java/final_grid_model_145 > final_grid_model_145.java
      javac -cp h2o-genmodel.jar -J-Xmx2g -J-XX:MaxPermSize=128m final_grid_model_145.java
...
...
class final_grid_model_145_Tree_0_class_0 {
  static final double score0(double[] data) {
    double pred =      (data[1 /* sex */] <0.5f ? 
         (data[7 /* cabin */] <183.5f ? 
             (!Double.isNaN(data[4]) && data[4 /* parch */] != 2.0f ? 
                 (data[6 /* fare */] <35.35588f ? 
                    0.11565409f : 
                    0.13087687f) : 
                0.10719699f) : 
             (data[3 /* sibsp */] <2.0009804f ? 
                 (data[6 /* fare */] <40.706825f ? 
                     (data[5 /* ticket */] <250646.5f ? 
                         (data[5 /* ticket */] <12966.5f ? 
                             (data[5 /* ticket */] <2673.0f ? 
                                0.10043131f : 
                                -0.021350924f) : 
                             (data[4 /* parch */] <7.3529413E-4f ? 
                                 (data[5 /* ticket */] <237262.5f ? 
                                     (data[2 /* age */] <41.011906f ? 
                                        0.13087687f : 
                                        0.104237005f) : 
                                    0.08351711f) : 
                                0.13087687f)) : 
                         (data[5 /* ticket */] <347066.5f ? 
...
```
