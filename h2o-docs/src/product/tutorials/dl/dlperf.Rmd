...
Notes:
  ...
  * It is not clear to me why the last *hidden* layer was specified to have 10 neurons, as the output layer will also have 10 neurons (one per class, automatically done by H2O if `do_classification` is set). This dimensionality reduction severely limits the predictive accuracy.
