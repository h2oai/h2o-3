...
Notes:
  ...
  * Hardware specs: [MacBook Pro Late 2013 2.6GHz](http://support.apple.com/kb/SP690).
...
When training for 10 hours on 10 nodes, we achieve 0.83% test set error, which is the current world record for models without convolutional layers, data augmentation or unsupervised pre-training.
