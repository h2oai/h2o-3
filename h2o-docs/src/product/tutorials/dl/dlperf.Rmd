...
Notes:
  ...
  * A large part of the benchmark study was the distributed scalability (strong scaling) of H2O (at least in terms of throughput) which we'll address in part 3, but as noted earlier, almost linear speedups can be achieved when adding compute nodes as the communication overhead is fully user-controllable.
