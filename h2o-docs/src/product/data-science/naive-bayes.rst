...
-  `nfolds <algo-params/nfolds.html>`__: Specify the number of folds for cross-validation. This value defaults to ``0`` (disable) or can be :math:`\geq` ``2``. 
...
-  `laplace <algo-params/laplace.html>`__: Specify the Laplace smoothing parameter. The value must be an integer :math:`\geq` 0. This value defaults to ``0``.

-  `min_sdev <algo-params/min_sdev.html>`__: Specify the minimum standard deviation to use for observations without enough data. The value must be at least 1e-10 and defaults to ``0.001``.
...
-  `min_prob <algo-params/min_prob.html>`__: Specify the minimum probability to use for observations without enough data. This value defaults to ``0.001``.
