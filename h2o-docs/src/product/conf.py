...
# Substitutions/variables for H2O-3 topics
# These work with the sphinx_substitution_extensions
# and sphinx-prompt extensions. 
# These subsitutions only work in code samples, and you must
# use the ".. sphinx-substition:: bash" (or Python, or R) to define 
# the code sample.
substitutions = [
