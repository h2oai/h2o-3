def python_vignette():
    ...
    story27 = [pyunit_utils.locate("Python_Vignette_code_examples/python_histogramming_data.py")]
    story28 = [pyunit_utils.locate("Python_Vignette_code_examples/python_initializeh2o_example.py")]
    story29 = [pyunit_utils.locate("Python_Vignette_code_examples/python_injest_time_natively.py")]
    story30 = [pyunit_utils.locate("Python_Vignette_code_examples/python_join_results.py")]
    story31 = [pyunit_utils.locate("Python_Vignette_code_examples/python_merge_frames_by_column_name.py")]
    story32 = [pyunit_utils.locate("Python_Vignette_code_examples/python_randomized_grid_search.py")]
    story33 = [pyunit_utils.locate("Python_Vignette_code_examples/python_replace_first_l_with_x.py")]
    story34 = [pyunit_utils.locate("Python_Vignette_code_examples/python_retain_common_categories.py")]
    story35 = [pyunit_utils.locate("Python_Vignette_code_examples/python_scikit_learn_pipeline.py")]
    story36 = [pyunit_utils.locate("Python_Vignette_code_examples/python_select_column_index.py")]
    story37 = [pyunit_utils.locate("Python_Vignette_code_examples/python_select_column_name.py")]
    story38 = [pyunit_utils.locate("Python_Vignette_code_examples/python_select_multiple_column_names.py")]
    story39 = [pyunit_utils.locate("Python_Vignette_code_examples/python_select_multiple_columns_by_index.py")]
    story40 = [pyunit_utils.locate("Python_Vignette_code_examples/python_select_rows_boolean.py")]
    story41 = [pyunit_utils.locate("Python_Vignette_code_examples/python_select_rows_by_slicing.py")]
    story42 = [pyunit_utils.locate("Python_Vignette_code_examples/python_show_column_types.py")]
    story43 = [pyunit_utils.locate("Python_Vignette_code_examples/python_split_using_regex.py")]
    story44 = [pyunit_utils.locate("Python_Vignette_code_examples/python_train_gbm_model.py")]
    story45 = [pyunit_utils.locate("Python_Vignette_code_examples/python_train_gbm_multinomial_model.py")]
    story46 = [pyunit_utils.locate("Python_Vignette_code_examples/python_train_glm_model.py")]
    story47 = [pyunit_utils.locate("Python_Vignette_code_examples/python_train_kmeans_model.py")]
    story48 = [pyunit_utils.locate("Python_Vignette_code_examples/python_train_pca_model.py")]
    story49 = [pyunit_utils.locate("Python_Vignette_code_examples/python_view_categorical_levels_in_column.py")]
    ...
    pybooklet_utils.check_story("story46",story46)
    pybooklet_utils.check_story("story47",story47)
