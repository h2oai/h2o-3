...
\item To stop model building if the moving average of the (window 5) AUC improves (goes up) by less than 0.001 for 5 consecutive scoring events, specify \texttt{stopping\_rounds=5}, \texttt{stopping\_tolerance=0.001} and \texttt{stopping\_metric="AUC"}.
