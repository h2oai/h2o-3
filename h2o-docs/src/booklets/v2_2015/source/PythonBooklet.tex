...
\lstinputlisting[style=pythoncode]{Python_Vignette_code_examples/python_train_gbm_model.py}

To generate a classification model that uses labels, \\ use 
{\texttt{distribution="multinomial"}}:

\lstinputlisting[style=pythoncode]{Python_Vignette_code_examples/python_train_gbm_multinomial_model.py}
...
\lstinputlisting[style=pythoncode]{Python_Vignette_code_examples/python_train_glm_model.py}
...
\lstinputlisting[style=pythoncode]{Python_Vignette_code_examples/python_train_kmeans_model.py}
...
\lstinputlisting[style=pythoncode]{Python_Vignette_code_examples/python_train_pca_model.py}


\subsection{Grid Search}
H2O supports grid search across hyperparameters:

\lstinputlisting[style=pythoncode]{Python_Vignette_code_examples/python_grid_search.py}
...
\lstinputlisting[style=pythoncode]{Python_Vignette_code_examples/python_scikit_learn_pipeline.py}
...
\lstinputlisting[style=pythoncode]{Python_Vignette_code_examples/python_randomized_grid_search.py}
