...
%TODO: Fix this doc so that everything in this section that is commented out works. It should be able to reference the bibliography the same way as GLM_Vignette.tex and GBM_Vignette.tex. Can't get it to work right, so hard-coding this section for now. 

\bibliographystyle{plain}  %alphadin}
...
Anqi Fu. {\textbf{Big Data Science in H2O with R}}, 2013. URL {\url{http://h2o.ai/blog/2013/08/big-data-science-in-h2o-with-r/}}
H2O.ai Team. {\textbf{H2O website}}, 2015. URL {\url{http://h2o.ai}}H2O.ai Team. {\textbf{H2O documentation}}, 2015. URL {\url{http://docs.h2o.ai}}H2O.ai Team. {\textbf{H2O GitHub Repository}}, 2015. URL {\url{https://github. com/h2oai}}H2O.ai Team. {\textbf{H2O Datasets}}, 2015. URL {\url{http://data.h2o.ai}}
 H2O.ai Team. {\textbf{H2O JIRA}}, 2015. URL {\url{https://jira.h2o.ai}}H2O.ai Team. {\textbf{H2Ostream}}, 2015. URL {\url{https://groups.google.com/ d/forum/h2ostream}}H2O.ai Team. {\textbf{H2O R Package Documentation}}, 2015. URL {\url{http:// h2o-release.s3.amazonaws.com/h2o/latest_stable_Rdoc.html}}
Erin LeDell. {\textbf{R Ensemble Documentation}}, 2014. URL {\url{http://www.stat.berkeley.edu/~ledell/R/h2oEnsemble.pdf}}
R Core Team. {\textbf{R: A Language and Environment for Statistical Computing}}, 2015. URL {\url{https://www.R-project.org}}
