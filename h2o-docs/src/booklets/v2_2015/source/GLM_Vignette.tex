...
can also get metrics like AUC if you include the response column in the new data.  Here is an example for logistic
regression (i.e. binomial classification):
