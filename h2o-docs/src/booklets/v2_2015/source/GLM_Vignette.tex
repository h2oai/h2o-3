...
\lstinputlisting[style=R]{glm/glm_gaussian_example.py}
...
\waterExampleInPython
\lstinputlisting[style=R]{glm/glm_binomial_example.py}
...
\waterExampleInPython
\lstinputlisting[style=R]{glm/glm_poisson_example.py}
...
\waterExampleInPython
\lstinputlisting[style=R]{glm/glm_gamma_example.py}
...
\waterExampleInPython
\lstinputlisting[style=R]{glm/glm_tweedie_example.py}
...
\waterExampleInPython
\lstinputlisting[style=R]{glm/glm_stopping_criteria.py}
