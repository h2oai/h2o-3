...
\\
\bigskip
\textsc{\small{Nadine Hussami  \hspace{10pt} Tom Kraljevic \hspace{10pt} \hspace{10pt} Jessica Lanford \\ \hspace{10pt} Tomas Nykodym \hspace{10pt} Ariel Rao \hspace{10pt} Amy Wang }}
\\
\bigskip
...
When using the $\ell_1$ penalty with lambda search, specify the \\ \texttt{max\_active\_predictors} parameter to stop
