...
\texttt{remove\_collinear\_columns} option. Otherwise, H2O will return an error. If there are collinear columns and
P-values are requested, then regularization cannot be added.
