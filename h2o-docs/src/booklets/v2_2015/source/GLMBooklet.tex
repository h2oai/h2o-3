...
\textbf{Note:} If an alpha array is specified and for a branch new alpha, the model will be built from scratch regardless of the value of \texttt{cold\_start}.
