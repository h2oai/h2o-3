...
This document introduces the reader to Gradient Boosted Machines with H2O.  Examples are written in R and python.
...
%---- TODO add parameter for algo can be passed into installation.tex file
...
% --- TODO: Update this section (reuse GLM Appendix)
\begin{itemize}
...
typically uses very shallow trees. Bin limits over 20 have been shown to provide very little improvement on
