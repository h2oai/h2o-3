...
\item{\texttt{max\_abs\_leafnode\_pred}}: Limits the maximum absolute value of a leaf node prediction. The default is Double.MAX_Value.
...
\item{\texttt{learn\_rate\_annealing}}: Reduces the {\texttt{learn_rate}} by this factor after every tree. 
