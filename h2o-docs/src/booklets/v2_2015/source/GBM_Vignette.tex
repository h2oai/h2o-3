...
\begin{itemize}
% --- TODO not just MSE, different error for each distribution
...
%--- TODO grid search doesn't work on latest nightly in R
\waterExampleInR
\lstinputlisting[style=R]{gbm/gbm_gridsearch.R}

\waterExampleInPython
\lstinputlisting[style=python]{gbm/gbm_gridsearch.py}
...
\waterExampleInPython
\lstinputlisting[style=python]{gbm/gbm_gridsearch_result.py}
