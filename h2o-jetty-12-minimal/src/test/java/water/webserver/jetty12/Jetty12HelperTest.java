...
public class Jetty12HelperTest {
  ...
  public void testCreateJettyServerWithSSL() {
    ...
    Server s = new Jetty12Helper(_hhView).createJettyServer("127.0.0.1", 0);
  ...
  public void testMakeHttpConfiguration() {
    HttpConfiguration defaultCfg = Jetty12Helper.makeHttpConfiguration(new ConnectionConfiguration(false));
    ...
    HttpConfiguration customCfg = Jetty12Helper.makeHttpConfiguration(ccMock);
  ...
  public void testAuthWrapper() {
    ...
    final Jetty12Helper helper = new Jetty12Helper(_hhView);
