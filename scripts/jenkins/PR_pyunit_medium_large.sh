...
echo ""
echo "*********************************************"
echo "*  Running large Python tests"
echo "*********************************************"
echo ""
cd h2o-py/tests
printf "pyunit_pub_445_request_uri_large.py\npyunit_DEPRECATED_cv_cars_mediumDeepLearning.py\npyunit_random_attack_medium.py"> skippedtests.txt
../../scripts/run.py --wipeall --geterrs --testsize ml --excludelist skippedtests.txt --numclouds 1 --numnodes 5 --baseport 56789 --jvm.xmx 13g
