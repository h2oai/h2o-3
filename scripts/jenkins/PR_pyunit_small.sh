...
rm -f -r h2o-py/tests/testdir_hdfs

echo ""
echo "*********************************************"
echo "*  Running small pyunit tests"
echo "*********************************************"
echo ""
cd h2o-py/tests
../../scripts/run.py --wipeall --geterrs --testsize s --numclouds 6 --baseport $BASE_PORT --jvm.xmx 4g --excludelist ../../tests/pyunitSmokeTestList

echo ""
echo "*********************************************"
echo "*  Running small pyunit demos"
echo "*********************************************"
echo ""
cd ../demos
../../scripts/run.py --wipeall --geterrs --testsize s --numclouds 6 --baseport $BASE_PORT --jvm.xmx 4g
