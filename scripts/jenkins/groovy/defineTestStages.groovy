def call(final pipelineContext) {
  ...
  def SMOKE_STAGES = [
          [
                  stageName: 'Py3.7 Fault Tolerance (1)', target: 'test-pyunit-fault-tolerance', pythonVersion: '3.7',
                  timeoutValue: 30, component: pipelineContext.getBuildConfig().COMPONENT_PY
          ],
          [
                  stageName: 'Py3.7 Fault Tolerance (2)', target: 'test-pyunit-fault-tolerance', pythonVersion: '3.7',
                  timeoutValue: 30, component: pipelineContext.getBuildConfig().COMPONENT_PY
          ],
          [
                  stageName: 'Py3.7 Fault Tolerance (3)', target: 'test-pyunit-fault-tolerance', pythonVersion: '3.7',
                  timeoutValue: 30, component: pipelineContext.getBuildConfig().COMPONENT_PY
          ],
          [
                  stageName: 'Py3.7 Fault Tolerance (4)', target: 'test-pyunit-fault-tolerance', pythonVersion: '3.7',
                  timeoutValue: 30, component: pipelineContext.getBuildConfig().COMPONENT_PY
          ],
          [
                  stageName: 'Py3.7 Fault Tolerance (5)', target: 'test-pyunit-fault-tolerance', pythonVersion: '3.7',
                  timeoutValue: 30, component: pipelineContext.getBuildConfig().COMPONENT_PY
          ],
          [
                  stageName: 'Py3.7 Fault Tolerance (6)', target: 'test-pyunit-fault-tolerance', pythonVersion: '3.7',
                  timeoutValue: 30, component: pipelineContext.getBuildConfig().COMPONENT_PY
          ],
          [
                  stageName: 'Py3.7 Fault Tolerance (7)', target: 'test-pyunit-fault-tolerance', pythonVersion: '3.7',
                  timeoutValue: 30, component: pipelineContext.getBuildConfig().COMPONENT_PY
          ],
          [
                  stageName: 'Py3.7 Fault Tolerance (8)', target: 'test-pyunit-fault-tolerance', pythonVersion: '3.7',
                  timeoutValue: 30, component: pipelineContext.getBuildConfig().COMPONENT_PY
          ]
  ]
