...
class BuildConfig {
  ...
  public static final int DEFAULT_IMAGE_VERSION_TAG = 24
  ...
  private static final String K8S_IMAGE_VERSION_TAG = '1'
  ...
  String getK8SImageVersion() {
    return K8S_IMAGE_VERSION_TAG
  }
