...
master_jobname_plot = qplot(x=JobName, y=AvgDuration, fill=JobName,
...
master_testname_plot = qplot(x=TestName, y=AvgDuration, fill=TestName,
...
master_jobname_testname_plot = qplot(x=JobName, y=AvgDuration, fill=TestName,
