...
JVM="nice $JAVA_CMD -ea -Xmx3g -Xms3g -cp build/libs/h2o-avro-parser-test.jar${SEP}build/libs/h2o-avro-parser.jar${SEP}../../h2o-core/build/libs/h2o-core-test.jar${SEP}../../h2o-core/build/libs/h2o-core.jar${SEP}../../h2o-genmodel/build/libs/h2o-genmodel.jar${SEP}../../h2o-codegen-build/build/libs/h2o-codegen-base.jar${SEP}../../lib/*"
