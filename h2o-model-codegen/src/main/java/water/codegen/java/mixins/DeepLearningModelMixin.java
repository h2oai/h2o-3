...
public class DeepLearningModelMixin extends ModelMixin {
  ...
  @CG.Manual(comment = "Thread-local storage for input neuron activation values.")
  public final double[] NUMS;

  @CG.Delegate(target = "#model_info#data_info._normMul", comment = "Standardization/Normalization scaling factor for numerical variables.")
  public static final double[] NORMMUL = null;

  @CG.Delegate(target = "#model_info#data_info._normSub", comment = "Standardization/Normalization offset for numerical variables.")
  ...
  @CG.Delegate(target = "#model_info#data_info._normRespMul", comment = "Standardization/Normalization scaling factor for response.")
  public static final double[] NORMRESPMUL = null;

  @CG.Delegate(target = "#model_info#data_info._normRespSub", comment = "Standardization/Normalization offset for response.")
  ...
  @CG.Manual(comment = "Connecting weights between neurons.")
  public static final float[][] WEIGHT = null;

  @CG.Manual(comment = "Neuron bias values.")
  public static final double[][] BIAS = null;


  /**
   * AutoGenerated properties
   */
  @CG.Delegate(target = "#model_info#data_info._cats")
  private static final int GEN_CATS = -1;

  @CG.Delegate(target = "#model_info#data_info._nums")
  private static final int GEN_NUMS = -1;

  @CG.Delegate(target = "#model_info#data_info._useAllFactorLevels")
  private static final boolean GEN_USE_ALL_FACTOR_LEVELS = false;

  @CG.Delegate(target = "#model_info#get_params._activation#isTanh")
  private static final boolean GEN_IS_TANH = false;

  @CG.Delegate(target = "#model_info#get_params._activation#isRelu")
  private static final boolean GEN_IS_RELU = false;

  @CG.Delegate(target = "#model_info#get_params._activation#isMaxout")
  private static final boolean GEN_IS_MAXOUT = false;

  @CG.Delegate(target = "#model_info#get_params._autoencoder")
  private static final boolean GEN_IS_AUTOENCODER = false;

  @CG.Delegate(target = "#model_info#data_info#numStart")
