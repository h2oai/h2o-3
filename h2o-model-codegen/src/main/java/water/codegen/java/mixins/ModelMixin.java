...
public class ModelMixin {
  ...
  @CG.Delegate(target = "._output._names", comment = "Names of features used by model training")
  ...
  @CG.Delegate(target = "._output._priorClassDist", comment = "Prior class distribution", when="#isSupervised")
  public static final double[] PRIOR_CLASS_DISTRIB = null;

  // FIXME remove to supervised ModelMixin !!!
  @CG.Delegate(target = "._output._modelClassDist", comment = "Class distribution used for model building", when="#isSupervised")
