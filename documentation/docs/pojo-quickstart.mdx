---
title: "POJO quick start"
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

This section describes how to build and implement a POJO to use predictive scoring. Java developers should refer to the [Javadoc](http://docs.h2o.ai/h2o/latest-stable/h2o-genmodel/javadoc/index.html) for more information, including packages.
...
2.  Build a model using your web browser:
    ...
    1.  Go to [http://localhost:54321](http://localhost:54321)
    2.  Click **View Example Flows** near the right edge of the screen. Here is a screenshot of what to look for:

        ![View example Flows button in H2O Flow](howto/images/view_example_flows.png)
    ...
    6.  Scroll down and find the **Model** cell in the notebook. Click the **Download POJO** button as shown in the following screenshot:

        ![Download POJO button in the Model cell](howto/images/download_pojo.png)

    :::note
    The instructions below assume that the POJO model was downloaded to the "Downloads" folder.
    :::
...
> Here are our requirements (assuming you are using the "easy" Prediction API for the POJO as described in the [Javadoc](http://docs.h2o.ai/h2o/latest-stable/h2o-genmodel/javadoc/index.html)).
>
...
> > - Some models do not handle NAs well (for example, GLM)
