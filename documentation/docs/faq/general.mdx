...
The only prerequisite for running H2O is a compatible version of [Java](http://docs.h2o.ai/h2o/latest-stable/h2o-docs/welcome.html#java-requirements).
...
To compare multiple models simultaneously, use the POJO to call the models using multiple threads. For more information on using POJOs, refer to the [POJO Quick Start Guide](pojo-quick-start) and [POJO Java Documentation](../h2o-genmodel/javadoc/index)
...
- Malohlava, M., Hava, J., and Mehta, N. (October 2022) *Machine Learning with Sparkling Water: H2O + Spark* [https://docs.h2o.ai/sparkling-water/3.3/latest-stable/booklet/SparklingWaterBooklet.pdf](https://docs.h2o.ai/sparkling-water/3.3/latest-stable/booklet/SparklingWaterBooklet.pdf).

To cite H2O AutoML, please use the instructions [here](../automl#citation).
