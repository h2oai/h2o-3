...
<figure>
<img src="../images/Flow_Pvalues.png" alt="../images/Flow_Pvalues.png" />
</figure>
...
- [Scala](https://github.com/h2oai/sparkling-water/blob/master/examples/scripts/craigslistJobTitles.script.scala)

Use TF-IDF weighting scheme for classifying text messages:

- [Scala](https://github.com/h2oai/sparkling-water/blob/master/examples/scripts/hamOrSpam.script.scala)
...
<figure>
<img src="../images/Flow_Parse_ConvertEnum.png" alt="../images/Flow_Parse_ConvertEnum.png" />
</figure>
...
<figure>
<img src="../images/Flow_Summary_ConvertToEnum.png" alt="../images/Flow_Summary_ConvertToEnum.png" />
</figure>
