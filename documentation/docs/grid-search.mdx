...
- [Grid Search in R](#grid-search-in-r)
...
- [Caveats/In Progress](#caveats-in-progress)
...
This is a named list of control parameters for smarter hyperparameter search. The list can include values for: `strategy`, `max_models`, `max_runtime_secs`, `stopping_metric`, `stopping_tolerance`, `stopping_rounds` and `seed`. The default value for `strategy`, "Cartesian", covers the entire space of hyperparameter combinations. If you want to use cartesian grid search, you can leave the `search_criteria` argument unspecified. Specify the "RandomDiscrete" strategy to perform a random search of all the combinations of your hyperparameters. RandomDiscrete should be usually combined with at least one early stopping criterion, `max_models` and/or `max_runtime_secs`. You can also use "Sequential", which goes through the specified parameters in sequence and requires the specified parameter lists to have the same length. "Sequential" strategy exposes `early_stopping` parameter (defaults to TRUE) that can be used to disable early stopping while still obeying the `max_models` and `max_runtime_secs`. Some examples below:
...
|------------------------------------|--------------------------------------------------------------------|--------------------------------------------------------------------|--------------------------------------------------------------------|--------------------------------------------------------------------|--------------------------------------------------------------------|--------------------------------------------------------------------|
| `col_sample_rate`                  | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      |
| `col_sample_rate_change_per_level` | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `col_sample_rate_per_tree`         | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `histogram_type`                   | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `learn_rate`                       | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      |
| `max_abs_leafnode_pred`            | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      |
| `max_depth`                        | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `min_rows`                         | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `min_split_improvement`            | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `mtries`                           | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `nbins`                            | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `nbins_cats`                       | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `nbins_top_level`                  | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `ntrees`                           | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `sample_rate`                      | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `sample_rate_per_class`            | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `sample_size`                      | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      |
| `seed`                             | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> |
| `learn_rate_annealing`             | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      |
| `pred_noise_bandwidth`             | <img src="/images/checkmark.png" className="align-middle" alt="yes" /> | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      | <img src="/images/xmark.png" className="align-middle" alt="no" />      |
...
- [H2O Core Java Developer Documentation](../h2o-core/javadoc/index): The definitive Java API guide for the core components of H2O.
- [H2O Algos Java Developer Documentation](../h2o-algos/javadoc/index): The definitive Java API guide for the algorithms used by H2O.
