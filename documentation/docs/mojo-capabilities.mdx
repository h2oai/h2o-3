...
Subclasses of [ModelAttributes](http://docs.h2o.ai/h2o/latest-stable/h2o-genmodel/javadoc/hex/genmodel/attributes/ModelAttributes.html) are used to handle model-specific attributes (e.g. Variable Importance).
