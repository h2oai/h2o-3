...
H2O-3 supports R as a first-class client language.
...
You can find instructions for using H2O-3 with R in the [Downloading and installing H2O](../downloading#install-in-r) section and on the [Downloads page](http://h2o-release.s3.amazonaws.com/h2o/latest_stable.html).
