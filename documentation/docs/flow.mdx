...
<figure>
<img src="images/Flow_shortcuts.png" alt="images/Flow_shortcuts.png" />
</figure>
...
<figure>
<img src="images/Flow_AssistMeButton.png" alt="images/Flow_AssistMeButton.png" />
</figure>
...
<figure>
<img src="images/Flow_assist.png" alt="images/Flow_assist.png" />
</figure>
...
> <figure>
> <img src="images/Flow_SidebarHide.png" alt="images/Flow_SidebarHide.png" />
> </figure>
...
<figure>
<img src="images/Flow_ExampleFlows.png" alt="images/Flow_ExampleFlows.png" />
</figure>
...
<figure>
<img src="images/Flow_REST_docs.png" alt="images/Flow_REST_docs.png" />
</figure>
...
<figure>
<img src="images/Flow_clips.png" alt="images/Flow_clips.png" />
</figure>
...
> <figure>
> <img src="images/Flow_outline.png" alt="images/Flow_outline.png" />
> </figure>
...
<figure>
<img src="images/Flow_rename.png" alt="images/Flow_rename.png" />
</figure>

To confirm the name, click the checkmark to the right of the name field.

<figure>
<img src="images/Flow_rename2.png" alt="images/Flow_rename2.png" />
</figure>
...
<figure>
<img src="images/Flow_flows.png" alt="images/Flow_flows.png" />
</figure>
...
<figure>
<img src="images/Flow_confirmreplace.png" alt="images/Flow_confirmreplace.png" />
</figure>
...
<figure>
<img src="images/Flow_Open.png" alt="images/Flow_Open.png" />
</figure>
...
<figure>
<img src="images/Flow_EditMode.png" alt="images/Flow_EditMode.png" />
</figure>
...
>
> <figure>
> <img src="images/Flow_markdown.png" alt="images/Flow_markdown.png" />
> </figure>

- **CS**: Code (default)

> <figure>
> <img src="images/Flow_parse_code_ex.png" alt="images/Flow_parse_code_ex.png" />
> </figure>

- **RAW**: Raw format (for code comments)

> <figure>
> <img src="images/Flow_raw.png" alt="images/Flow_raw.png" />
> </figure>

- **H\[1-6\]**: Heading level (where 1 is a first-level heading)

> <figure>
> <img src="images/Flow_headinglevels.png" alt="images/Flow_headinglevels.png" />
> </figure>
>
> **NOTE**: If there is an error in the cell, the flag is red.
>
> <figure>
> <img src="images/Flow_redflag.png" alt="images/Flow_redflag.png" />
> </figure>

If the cell is executing commands, the flag is teal. The flag returns to yellow when the task is complete.

<figure>
<img src="images/Flow_cellmode_runningflag.png" alt="images/Flow_cellmode_runningflag.png" />
</figure>
...
<figure>
<img src="images/Flow_RunButtons.png" alt="images/Flow_RunButtons.png" />
</figure>
...
<figure>
<img src="images/Flow_progressbar.png" alt="images/Flow_progressbar.png" />
</figure>
...
```
<figure>
<img src="images/Flow_VariableDefinition.png" alt="images/Flow_VariableDefinition.png" />
</figure>
```
...
> <figure>
> <img src="images/Flow_VariableValidation.png" alt="images/Flow_VariableValidation.png" />
> </figure>

3.  Use the variable in another code cell (for example, `importFiles [locA]`).

> <figure>
> <img src="images/Flow_VariableExample.png" alt="images/Flow_VariableExample.png" />
> </figure>
...
<figure>
<img src="images/Flow_buttons.png" alt="images/Flow_buttons.png" />
</figure>
...
<figure>
<img src="images/Flow_import_results.png" alt="images/Flow_import_results.png" />
</figure>
...
<figure>
<img src="images/Flow_UploadDataset.png" alt="images/Flow_UploadDataset.png" />
</figure>

When the file has uploaded successfully, a message displays in the upper right and the **Setup Parse** cell displays.

<figure>
<img src="images/Flow_FileUploadPass.png" alt="images/Flow_FileUploadPass.png" />
</figure>
...
<figure>
<img src="images/Flow_parse_setup.png" alt="images/Flow_parse_setup.png" />
</figure>
...
<figure>
<img src="images/Flow_ColNameEntry.png" alt="images/Flow_ColNameEntry.png" />
</figure>
...
<figure>
<img src="images/Flow_PageButtons.png" alt="images/Flow_PageButtons.png" />
</figure>
...
<figure>
<img src="images/Flow_impute.png" alt="images/Flow_impute.png" />
</figure>
...
<figure>
<img src="images/Flow_getJobs.png" alt="images/Flow_getJobs.png" />
</figure>
...
<figure>
<img src="images/Flow_ViewJob_Model.png" alt="images/Flow_ViewJob_Model.png" />
</figure>
...
<figure>
<img src="images/Flow_ModelBuilder.png" alt="images/Flow_ModelBuilder.png" />
</figure>

In the **Build a Model** cell, select an algorithm from the drop-down menu. (Refer to the [Data Science Algorithms](data-science) section for information about the available algorithms.) Available algorithms include:
...
>
> <figure>
> <img src="images/Flow_model_dropdown.png" width="150" height="308" alt="images/Flow_model_dropdown.png" />
> </figure>
...
<figure>
<img src="images/Flow_getModels.png" alt="images/Flow_getModels.png" />
</figure>
...
<figure>
<img src="images/Flow_viewModel.png" alt="images/Flow_viewModel.png" />
</figure>
...
<figure>
<img src="images/ExportModel.png" alt="images/ExportModel.png" />
</figure>
...
<figure>
<img src="images/ImportModel.png" alt="images/ImportModel.png" />
</figure>
...
<figure>
<img src="images/Flow_Model_RunAutoML.png" width="150" height="308" alt="images/Flow_Model_RunAutoML.png" />
</figure>
...
<figure>
<img src="images/Flow_RunAutoML.png" width="611" height="781" alt="images/Flow_RunAutoML.png" />
</figure>

Click the **View** button to view the Leaderboard and/or monitor the current AutoML run.

<figure>
<img src="images/Flow_ViewButton.png" width="1043" height="438" alt="images/Flow_ViewButton.png" />
</figure>
...
<figure>
<img src="images/Flow_ViewLeaderboard.png" width="820" height="474" alt="images/Flow_ViewLeaderboard.png" />
</figure>
...
<figure>
<img src="images/Flow_GridSearch.png" alt="images/Flow_GridSearch.png" />
</figure>
...
<figure>
<img src="images/Flow_ConfusionMatrix.png" alt="images/Flow_ConfusionMatrix.png" />
</figure>
...
<figure>
<img src="images/Flow_ROC.png" alt="images/Flow_ROC.png" />
</figure>
...
<figure>
<img src="images/HitRatioTable.png" alt="images/HitRatioTable.png" />
</figure>
...
<figure>
<img src="images/SCM.png" alt="images/SCM.png" />
</figure>
...
> <figure>
> <img src="images/score_pdp_menu.png" alt="images/score_pdp_menu.png" />
> </figure>
...
>
> <figure>
> <img src="images/compute_pdp.png" alt="images/compute_pdp.png" />
> </figure>

3.  After the job is finished, click **View** to see the plots.

> <figure>
> <img src="images/pdp_summary.png" alt="images/pdp_summary.png" />
> </figure>
...
<figure>
<img src="images/Flow_makePredict.png" alt="images/Flow_makePredict.png" />
</figure>
...
<figure>
<img src="images/Flow_getPredict.png" alt="images/Flow_getPredict.png" />
</figure>
...
<figure>
<img src="images/GainsLift.png" alt="images/GainsLift.png" />
</figure>
...
<figure>
<img src="images/GainsLiftTable.png" alt="images/GainsLiftTable.png" />
</figure>
...
<figure>
<img src="images/Flow_CreateFrame.png" alt="images/Flow_CreateFrame.png" />
</figure>
...
<figure>
<img src="images/Flow_getFrame.png" alt="images/Flow_getFrame.png" />
</figure>
...
<figure>
<img src="images/Flow_inspectFrame.png" alt="images/Flow_inspectFrame.png" />
</figure>

This screenshot displays the results of clicking the **columns** link.

<figure>
<img src="images/Flow_inspectCol.png" alt="images/Flow_inspectCol.png" />
</figure>
...
<figure>
<img src="images/Flow_getFrames.png" alt="images/Flow_getFrames.png" />
</figure>
...
<figure>
<img src="images/Flow_splitFrame.png" alt="images/Flow_splitFrame.png" />
</figure>
...
<figure>
<img src="images/Flow_plottingFrames.png" alt="images/Flow_plottingFrames.png" />
</figure>
...
<figure>
<img src="images/Flow_plot.png" alt="images/Flow_plot.png" />
</figure>
...
<figure>
<img src="images/delete_frames.png" alt="images/delete_frames.png" />
</figure>

2.  List the Models, check off the model you want to delete, and click **Delete selected**.

<figure>
<img src="images/delete_models.png" alt="images/delete_models.png" />
</figure>
...
<figure>
<img src="images/Flow_CloudStatus.png" alt="images/Flow_CloudStatus.png" />
</figure>
...
<figure>
<img src="images/Flow_viewLog.png" alt="images/Flow_viewLog.png" />
</figure>
...
To download the logs for further analysis, click the **Admin** menu, then click **Download Log**. A new window opens and the logs download to your default download folder. You can close the new window after downloading the logs. Send the logs to [h2ostream](mailto:h2ostream@googlegroups.com) or file a JIRA ticket for issue resolution. (Refer to [Reporting Issues](#reporting-issues).)
...
<figure>
<img src="images/Flow_stacktrace.png" alt="images/Flow_stacktrace.png" />
</figure>
...
<figure>
<img src="images/Flow_NetworkTest.png" alt="images/Flow_NetworkTest.png" />
</figure>
...
<figure>
<img src="images/Flow_profiler.png" alt="images/Flow_profiler.png" />
</figure>
...
<figure>
<img src="images/Flow_timeline.png" alt="images/Flow_timeline.png" />
</figure>
