...
Copy and email the logs to [support@h2o.ai](mailto:support@h2o.ai) or submit them to [h2ostream@googlegroups.com](mailto:h2ostream@googlegroups.com) with a brief description of your Hadoop environment, including the Hadoop distribution and version.
...
Use YARN to obtain the `stdout` and `stderr` logs that are used for troubleshooting. To learn how to access YARN based on management software, version, and job status, see [Accessing YARN](#accessing-yarn).

1.  Click the **Applications** link to view all jobs, then click the **History** link for the job.

```
<figure>
<img src="images/YARN_AllApps_History.png" alt="images/YARN_AllApps_History.png" />
</figure>
```
...
```
<figure>
<img src="images/YARN_History_Logs.png" alt="images/YARN_History_Logs.png" />
</figure>
```

3.  Copy the information that displays and send it in an email to [support@h2o.ai](mailto:support@h2o.ai).

```
<figure>
<img src="images/YARN_History_Logs2.png" alt="images/YARN_History_Logs2.png" />
</figure>
```
...
```
<figure>
<img src="images/YARN_AllApps_AppMaster.png" alt="images/YARN_AllApps_AppMaster.png" />
</figure>
```
...
```
<figure>
<img src="images/YARN_AppMaster_Job.png" alt="images/YARN_AppMaster_Job.png" />
</figure>
```
...
```
<figure>
<img src="images/YARN_AppMaster_Logs.png" alt="images/YARN_AppMaster_Logs.png" />
</figure>
```

4.  Send the contents of the displayed files to [support@h2o.ai](mailto:support@h2o.ai).

```
<figure>
<img src="images/YARN_AppMaster_Logs2.png" alt="images/YARN_AppMaster_Logs2.png" />
</figure>
```
...
> <figure>
> <img src="images/Logs_cloudera5_1.png" alt="images/Logs_cloudera5_1.png" />
> </figure>
...
> <figure>
> <img src="images/Logs_cloudera5_2.png" alt="images/Logs_cloudera5_2.png" />
> </figure>
...
> <figure>
> <img src="images/Logs_ambari1.png" alt="images/Logs_ambari1.png" />
> </figure>

2.  From the Quick Links drop-down menu, select **ResourceManager UI**.

> <figure>
> <img src="images/Logs_ambari2.png" alt="images/Logs_ambari2.png" />
> </figure>
