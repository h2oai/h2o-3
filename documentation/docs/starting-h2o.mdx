...
There are a variety of ways to start H2O-3 depending on which client you would like to use. The instructions below assume that you already downloaded and installed H2O-3. If you have not, then please refer to the [Downloading & Installing H2O](downloading) section.
...
> <figure>
> <img src="images/anaconda_import_module.png" alt="images/anaconda_import_module.png" />
> </figure>

2.  Initialize H2O-3 using `h2o.init()`.

> <figure>
> <img src="images/anaconda_init.png" alt="images/anaconda_init.png" />
> </figure>

3.  Import the Airlines dataset. This dataset will be used to classify whether a flight will be delayed.

> <figure>
> <img src="images/anaconda_import_airlines.png" alt="images/anaconda_import_airlines.png" />
> </figure>

4.  Convert columns to factors.

> <figure>
> <img src="images/anaconda_convert_columns.png" alt="images/anaconda_convert_columns.png" />
> </figure>

5.  Set the predictor names and the response column name.

> <figure>
> <img src="images/anaconda_predictor_response.png" alt="images/anaconda_predictor_response.png" />
> </figure>

6.  Split the dataset into training and validation sets.

> <figure>
> <img src="images/anaconda_split_data.png" alt="images/anaconda_split_data.png" />
> </figure>

7.  Specify the number of bins that will be included in the historgram and then split.

> <figure>
> <img src="images/anaconda_nbins_cats.png" alt="images/anaconda_nbins_cats.png" />
> </figure>

8.  Train the models.

> <figure>
> <img src="images/anaconda_train_model.png" alt="images/anaconda_train_model.png" />
> </figure>

9.  Print the AUC scores for the training data and the validation data.

> <figure>
> <img src="images/anaconda_print_auc.png" alt="images/anaconda_print_auc.png" />
> </figure>
...
create a table of command line options (should you say expression or primary?)

</div>

<div className="todo">

provide examples for most common clusters
...
To start an H2O-3 node with 6GB of memory and a specific cluster name: `java -Xmx6g -jar h2o.jar -name MyCluster`
