...
The left side shows the steps that run the the R process and the right side shows the steps that run in the H2O cluster. The top layer is the TCP/IP network code that enables the two processes to communicate with each other.
...
<figure>
<img src="images/start_glm_from_r.png" alt="images/start_glm_from_r.png" />
</figure>
...
<figure>
<img src="images/retrieve_glm_result_from_r.png" alt="images/retrieve_glm_result_from_r.png" />
</figure>
...
<figure>
<img src="images/run_glm_from_r.png" alt="images/run_glm_from_r.png" />
</figure>
