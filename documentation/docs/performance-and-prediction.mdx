...
<figure>
<img src="images/lorenz_curve.png" alt="images/lorenz_curve.png" />
</figure>
...
**Notes** - Calculation of this metric can be very expensive on time and memory when the domain is big. So it is disabled by default. - To enable it setup system property `sys.ai.h2o.auc.maxClasses` to a number of maximum allowed classes.
...
<figure>
<img src="images/absolute_error.png" alt="images/absolute_error.png" />
</figure>
...
<figure>
<img src="images/aucpr_curve.png" alt="images/aucpr_curve.png" />
</figure>
...
<figure>
<img src="images/gainslift_plot.png" alt="images/gainslift_plot.png" />
</figure>
...
<figure>
<img src="images/gainslift_table.png" alt="images/gainslift_table.png" />
</figure>
...
<figure>
<img src="images/pdp_summary.png" width="355" height="483" alt="images/pdp_summary.png" />
</figure>
...
<figure>
<img src="images/pdp_ageVmean.png" alt="images/pdp_ageVmean.png" />
</figure>

<figure>
<img src="images/pdp_raceVmean.png" alt="images/pdp_raceVmean.png" />
</figure>
...
<figure>
<img src="images/pdp_multinomial.png" alt="images/pdp_multinomial.png" />
</figure>
...
**NOTE:** DeepLearning and StackedEnsemble support only approximate SHAP values using DeepSHAP \[[1](#ref9), [2](#ref10)\] with multiple baselines, and G-DeepSHAP \[[2](#ref10)\] respectively.
...
In the path dependent TreeSHAP, there is another column called <span className="title-ref">BiasTerm</span> that is added to the sum of the contributions to get the prediction $h(x) = \text{BiasTerm} + \sum_{i=1}^d \phi_i$, in the baseline SHAP. This <span className="title-ref">BiasTerm</span> is equal to $h(x^{(b)})$.
...
1.  19. Lundberg and S.-I. Lee, “A Unified Approach to Interpreting Model Predictions.” arXiv, Nov. 24, 2017. doi: 10.48550/arXiv.1705.07874.

<a id="ref10"></a>

2.  8.  Chen, S. M. Lundberg, and S.-I. Lee, “Explaining a series of models by propagating Shapley values,” Nat Commun, vol. 13, no. 1, Art. no. 1, Aug. 2022, doi: 10.1038/s41467-022-31384-3.

<a id="ref11"></a>

3.  7.  Laberge and Y. Pequignot, “Understanding Interventional TreeSHAP: How and Why it Works.” arXiv, Dec. 05, 2022. doi: 10.48550/arXiv.2209.15123.

<a id="ref12"></a>

4.  8.  Chen, I. C. Covert, S. M. Lundberg, and S.-I. Lee, “Algorithms to estimate Shapley value feature attributions.” arXiv, Jul. 15, 2022. Accessed: Jul. 18, 2022. \[Online\]. Available: [http://arxiv.org/abs/2207.07605](http://arxiv.org/abs/2207.07605)

<a id="ref13"></a>

5.  13. Sundararajan and A. Najmi, “The many Shapley values for model explanation.” arXiv, Feb. 07, 2020. doi: 10.48550/arXiv.1908.08474.
...
An end-to-end example from building a model through predictions using MOJOs is available in the [MOJO Quick Start](mojo-quickstart#mojo-quick-start) topic.

### Predict using POJOs

An end-to-end example from building a model through predictions using POJOs is available in the [POJO Quick Start](pojo-quickstart#pojo-quick-start) topic.
