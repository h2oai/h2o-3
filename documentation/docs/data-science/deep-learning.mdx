...
- [Deep Learning Booklet](https://docs.h2o.ai/h2o/latest-stable/h2o-docs/booklets/DeepLearningBooklet.pdf)
- Deep Learning in H2O Tutorial (R): [\[GitHub\]](https://htmlpreview.github.io/?https://github.com/ledell/sldm4-h2o/blob/master/sldm4-deeplearning-h2o.html)
- H2O + TensorFlow on AWS GPU Tutorial (Python Notebook) [\[Blog\]](https://www.h2o.ai/blog/h2o-tensorflow-on-aws-gpu/) [\[Github\]](https://github.com/h2oai/sparkling-water/blob/master/py/examples/notebooks/TensorFlowDeepLearning.ipynb)
