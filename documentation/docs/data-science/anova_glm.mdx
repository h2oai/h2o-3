...
Parameters are optional unless specified as *requried*. ANOVA GLM shares many [GLM parameters](glm#shared-glm-family-parameters).
...
> <figure>
> <img src="../images/ss_decomp.png" alt="../images/ss_decomp.png" />
> </figure>
