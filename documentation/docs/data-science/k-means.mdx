...
For more information, refer to ["A Fast Clustering Algorithm to Cluster Very Large Categorical Data Sets in Data Mining"](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.134.83&rep=rep1&type=pdf) and ["Extensions to the k-Means Algorithm for Clustering Large Data Sets with Catgorical Values"](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.15.4028&rep=rep1&type=pdf) by Zhexue Huang.
...
## Estimating <span className="title-ref">k</span> in K-Means

The steps below describe the method that K-Means uses in order to estimate <span className="title-ref">k</span>.
