...
Detailed information about each of these options is available in the [Solvers](../glm#solvers) section. The bullets below describe how the algorithm chooses the solver when `solver=AUTO`:
