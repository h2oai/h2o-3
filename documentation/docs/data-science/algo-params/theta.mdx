...
Refer to the [Negative Binomial Models](../glm#negative-binomial-models) topic for more inforamtion on how the `theta` value is used in negative binomial regression problems.
