...
For binomial classification choose between `AUC`, `"logloss"`, `"mean_per_class_error"`, `"RMSE"`, `"MSE"`. For multinomial classification choose between `"mean_per_class_error"`, `"logloss"`, `"RMSE"`, `"MSE"`. For regression choose between `"deviance"`, `"RMSE"`, `"MSE"`, `"MAE"`, `"RMSLE"`.
