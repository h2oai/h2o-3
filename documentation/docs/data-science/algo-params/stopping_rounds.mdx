...
Use this option to stop model training when the option selected for [stopping_metric](stopping_metric) doesn’t improve for this specified number of training rounds, based on a simple moving average. For example, given the following options:
