...
For GBM and DRF models, this value defaults to 0.00001; for XGBoost models, this value defaults to 0. Optimal values for this parameter are in the 1e-10 to 1e-3 range.
