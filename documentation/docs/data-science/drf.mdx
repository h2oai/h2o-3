...
- [min_rows](algo-params/min_rows) (Python) / **node_size** (R): Specify the minimum number of observations for a leaf. This value defaults to `1`.
...
[<img src="http://image.slidesharecdn.com/rfbrighttalk-140522173736-phpapp02/95/building-random-forest-at-scale-1-638.jpg?cb=1400782751.png" width="425" height="355" alt="image" />](http://www.slideshare.net/0xdata/rf-brighttalk)
