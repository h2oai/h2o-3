...
- [training_frame](algo-params/training_frame): (Required) Specify the dataset used to build the model. The `training_frame` should be a single column H2OFrame that is composed of the tokenized text. (Refer to [Tokenize strings](../data-munging/tokenize#tokenize-strings) in the Data Manipulation section for more information.) **NOTE**: In Flow, if you click the **Build a model** button from the `Parse` cell, the training frame is entered automatically.
...
- R: [https://github.com/h2oai/h2o-3/blob/master/h2o-r/h2o-package/R/w2vutils.R#L33](hhttps://github.com/h2oai/h2o-3/blob/master/h2o-r/h2o-package/R/w2vutils.R#L33)
