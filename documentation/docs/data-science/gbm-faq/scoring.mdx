...
You can also score models in parallel by downloading a POJO or MOJO for each model and embedding them in your own JVM-based scoring application. Tutorials on this process can be found in the [Productionizing H2O](../../productionizing) section.
