...
You can also score models in parallel by downloading a POJO or MOJO for each model, and then embedding those within a HIVE UDF to score the large dataset stored on Hadoop. Tutorials on this process can be found in the [Productionizing H2O](../../productionizing#productionizing-h2o) section.
