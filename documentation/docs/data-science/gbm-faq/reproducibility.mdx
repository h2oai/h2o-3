...
<figure>
<img src="../../images/GBMReproducibility_LeaderNode.png" alt="../../images/GBMReproducibility_LeaderNode.png" />
</figure>
...
3.  Save the H2O binary model. Refer to [Saving, Loading, Downloading, and Uploading Models](../../save-and-load-model#saving-loading-downloading-and-uploading-models) for more information. The binary model will contain the H2O version and the parameters used to train the model.
4.  Save the H2O logs. Refer to \[Downloading Logs\]([https://github.com/h2oai/h2o-3/blob/master/h2o-docs/src/product/logs.rst](https://github.com/h2oai/h2o-3/blob/master/h2o-docs/src/product/logs.rst))
...
<figure>
<img src="../../images/GBMReproducibility_ChunkSize_Logs.png" alt="../../images/GBMReproducibility_ChunkSize_Logs.png" />
</figure>
...
<figure>
<img src="../../images/GBMReproducibility_ListAllFrames.png" width="627" height="288" alt="../../images/GBMReproducibility_ListAllFrames.png" />
</figure>

<figure>
<img src="../../images/GBMReproducibility_ImportedFrame.png" width="444" height="269" alt="../../images/GBMReproducibility_ImportedFrame.png" />
</figure>
...
> <figure>
> <img src="../../images/GBMReproducibility_NodeLogs.png" alt="../../images/GBMReproducibility_NodeLogs.png" />
> </figure>
>
> 1.  Unzip the logs from one of the nodes (the node chosen does not matter) and open the info logs.
>
> <figure>
> <img src="../../images/GBMReproducibility_LogsFromSingleNode.png" alt="../../images/GBMReproducibility_LogsFromSingleNode.png" />
> </figure>
>
> 2.  In the logs, search for `Cloud of size N formed [...]`. For example, in this 3 node cluster, I am searching for the term: `Cloud of size 3 formed`.
>
> <figure>
> <img src="../../images/GBMReproducibility_CloudOrder_Logs.png" alt="../../images/GBMReproducibility_CloudOrder_Logs.png" />
> </figure>
>
...
> <!-- -->
>
> 1.  In the logs search for: `ParseSetup`
>
> <figure>
> <img src="../../images/GBMReproducibility_ParseSetup.png" alt="../../images/GBMReproducibility_ParseSetup.png" />
> </figure>
>
> You may have to try opening multiple zip files to find this term in the logs.
>
> 2.  Identify the IP and Port that processed the ParseSetup request - this will be the IP and Port in the ParseSetup line
>
> > <figure>
> > <img src="../../images/GBMReproducibility_NodeGettingRequests.png" alt="../../images/GBMReproducibility_NodeGettingRequests.png" />
> > </figure>

3.  Determine the order of the node found in Step 2.

```
> 1.  Using the node order document created in Step 1, identify the position of the node that is processing the requests
```
...
<figure>
<img src="../../images/GBMReproducibility_ClusterStatusButton.png" alt="../../images/GBMReproducibility_ClusterStatusButton.png" />
</figure>

<figure>
<img src="../../images/GBMReproducibility_ClusterStatus.png" alt="../../images/GBMReproducibility_ClusterStatus.png" />
</figure>
...
<figure>
<img src="../../images/GBMReproducibility_ClusterStatusNodeSelected.png" width="447" height="372" alt="../../images/GBMReproducibility_ClusterStatusNodeSelected.png" />
</figure>
