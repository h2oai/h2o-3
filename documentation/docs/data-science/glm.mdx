...
- `fractionalbinomial`: See ([Fractional Logit Model (Fraction Binomial)](#fractional-logit-model-fraction-binomial)). The response must be a numeric between 0 and 1.
