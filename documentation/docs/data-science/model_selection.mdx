...
- [offset_column](algo-params/offset_column): Specify a column to use as the offset; the value cannot be the same as the value for the `weights_column`. This wll be added to the combination of columns before applying the link function.
