...
Although the concept of stacking was originally developed in 1992 \[[1]()\], the theoretical guarantees for stacking were not proven until the publication of a paper titled, ["Super Learner"](https://doi.org/10.2202/1544-6115.1309), in 2007 \[[3]()\]. In this paper, it was shown that the Super Learner ensemble represents an asymptotically optimal system for learning.
...
> H2O now supports saving and loading ensemble models. The steps are the same as those described in the [Saving and Loading a Model](../save-and-load-model) section. For productionizing Stacked Ensemble models, we recommend using [MOJOs](http://docs.h2o.ai/h2o/latest-stable/h2o-docs/productionizing.html).
