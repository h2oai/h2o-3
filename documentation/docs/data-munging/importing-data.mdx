...
[See more on supported file formats](http://docs.h2o.ai/h2o/latest-stable/h2o-docs/getting-data-into-h2o.html#supported-file-formats) to ensure that you are using a supported file type.
