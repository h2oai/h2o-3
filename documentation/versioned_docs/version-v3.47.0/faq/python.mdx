...
``` bash
Downloading/unpacking http://h2o-release.s3.amazonaws.com/h2o/rel-shannon/12/Python/h2o-3.42.0.2-py2.py3-none-any.whl 
  Downloading h2o-3.42.0.2-py2.py3-none-any.whl (43.1Mb): 43.1Mb downloaded 
  Running setup.py egg_info for package from http://h2o-release.s3.amazonaws.com/h2o/rel-shannon/12/Python/h2o-3.42.0.2-py2.py3-none-any.whl 
