...
H2O supports two integration approaches: using the REST API or embedding H2O within your Java application.
...
- **Using the REST API:**
  ...
  You can access the REST API documentation within [Flow](../flow#viewing-rest-api-documentation), or on our REST API reference documentation.
...
- **Embedding H2O within your Java application:**
  ...
  The second way to use H2O with Java is to embed H2O within your Java application. An example describing how to do this is available in the [h2o-droplets repository](https://github.com/h2oai/h2o-droplets/tree/master/h2o-java-droplet).

------------------------------------------------------------------------

## How do I communicate with a remote cluster using the REST API?

Download the H2O distribution zip file from [https://www.h2o.ai/download](https://www.h2o.ai/download). The distribution zip includes a file named h2o-bindings-3.42.0.2.zip. This file contains all of the Java bindings necessary for communicating with a remote cluster via the REST API. The REST API reference documentation is available on our documentation site.
