---
title: Split datasets into training/testing/validating
---
...
For example, when specifying a 0.75/0.25 split, H2O-3 will produce a test/train split with an expected value of 0.75/0.25 rather than exactly 0.75/0.25. On small datasets, the sizes of the resulting splits will deviate from the expected value more than on big data, where they are close to exact.
:::
