...
## Why does a random feature gain importance as the number of trees increases?
...
GBM tuning tutorials for R, Python, and Flow are available [on the H2O-3 GitHub repository](https://github.com/h2oai/h2o-3/tree/master/h2o-docs/src/product/tutorials/gbm).
