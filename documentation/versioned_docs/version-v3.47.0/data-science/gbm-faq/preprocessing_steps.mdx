...
## Does the algorithm perform any sorting? (Does quantile binning require a sorting-based method or an iterative projection method?) Does the algorithm perform shuffling beforehand?
...
No, H2O automatically handles categorical feature levels for you.
