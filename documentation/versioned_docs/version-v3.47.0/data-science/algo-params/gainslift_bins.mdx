...
The [Kolmogorov-Smirnov (KS)](../../performance-and-prediction#kolmogorov-smirnov-ks-metric) metric represents the degree of separation between the positive and negative distribution functions for a binomial model. Detailed metrics per each group can be found in the Gains/Lift table.
