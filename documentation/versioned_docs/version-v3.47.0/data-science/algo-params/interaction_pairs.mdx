...
When using this parameter, specify a list of pairwise columns that should interact. When specified, GLM computes interactions only between the specified pairs rather than between all pairwise combinations.
