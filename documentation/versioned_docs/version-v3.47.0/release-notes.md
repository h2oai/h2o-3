...
you can tell what's in your version at a glance. This page is updated with every
H2O-3 Enterprise release.
...
This page covers the most recent releases. For the version history of earlier
releases, contact H2O support.
