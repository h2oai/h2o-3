...
<li>[<a href='https://0xdata.atlassian.net/browse/PUBDEV-6860'>PUBDEV-6860</a>] - Fixed an NPE that occurred when running Stacked Ensemble when the first Stacked Ensemble model did not include a response column. (STILL OPEN)
</li>
</ul>
