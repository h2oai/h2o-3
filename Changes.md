...
<li>[<a href='https://0xdata.atlassian.net/browse/PUBDEV-6015'>PUBDEV-6015</a>] - Deprecated support for Java 7 in H2O-3 standalone mode. (STILL OPEN)
</li>
</ul>
...
<li>[<a href='https://0xdata.atlassian.net/browse/PUBDEV-5820'>PUBDEV-5820</a>] -         Upgrade to Jetty 9 in Standalone, use Jetty 8/9 in Hadoop mode (STILL OPEN)
</li>
...
<li>[<a href='https://0xdata.atlassian.net/browse/PUBDEV-6011'>PUBDEV-6011</a>] - Upgraded lodash in Flow to >=4.17.5. (STILL OPEN)
</li>
<li>[<a href='https://0xdata.atlassian.net/browse/PUBDEV-6017'>PUBDEV-6017</a>] - Allow public access to H2O instances started from R/Python. This can be done with the new `bind_to_localhost` (Boolean) parameter, which can be specified in `h2o.init()`.  (STILL OPEN)
</li>
</ul>
...
<ul>
<li>[<a href='https://0xdata.atlassian.net/browse/PUBDEV-3216'>PUBDEV-3216</a>] - Added a Performance and Prediction section in the User Guide. (STILL OPEN)
</li>
