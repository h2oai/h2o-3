...
public class TEGridSearchIntegrationWithAutoMLTest extends water.TestUtil {
  ...
  @Test public void gridSearchEndedUpWithKFoldStrategyTest() {
    ...
    //This test shows that we overfit in 'autoAssignedFoldsCVScenarioTest' test due to applying TE to the whole training dataset, that will be used in training with CV
