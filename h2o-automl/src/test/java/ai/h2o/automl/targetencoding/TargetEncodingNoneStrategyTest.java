...
public class TargetEncodingNoneStrategyTest extends TestUtil {
  ...
  public void targetEncoderNoneHoldoutApplyingTest() {
    ...
    Frame resultWithEncoding = tec.applyTargetEncoding(fr, targetColumnName, targetEncodingMap, TargetEncoder.DataLeakageHandlingStrategy.None, foldColumn, false, 0, 1234);
  ...
  public void holdoutTypeNoneApplyWithNoiseTest() {
    ...
    Frame resultWithEncoding = tec.applyTargetEncoding(fr, targetColumnName, targetEncodingMap, TargetEncoder.DataLeakageHandlingStrategy.None, foldColumn, false, 1234);
  ...
  public void endToEndTest() {
    ...
    Frame resultWithEncoding = tec.applyTargetEncoding(training, targetColumnName, targetEncodingMap, TargetEncoder.DataLeakageHandlingStrategy.None, false, 0,  1234);
