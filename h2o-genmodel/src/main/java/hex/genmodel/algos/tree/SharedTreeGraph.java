...
public class SharedTreeGraph {
   ...
   */
  public void printDot(PrintStream os, int maxLevelsToPrintPerEdge, boolean detail, String optionalTitle, int fontsize) {
    os.println("/*");
    ...
    for (SharedTreeSubgraph sg : subgraphArray) {
      sg.printDot(os, maxLevelsToPrintPerEdge, detail, optionalTitle, fontsize);
    }
    os.println("");
    os.println("}");
    os.println("");
