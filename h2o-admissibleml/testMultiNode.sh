...
# Define JVM_CLASSPATH
JVM_CLASSPATH="build/classes/java/test${SEP}build/classes/java/main"
JVM_CLASSPATH="${JVM_CLASSPATH}${SEP}build/resources/test${SEP}build/resources/main"
JVM_CLASSPATH="${JVM_CLASSPATH}${SEP}../h2o-core/build/classes/java/test${SEP}../h2o-core/build/classes/java/main"
JVM_CLASSPATH="${JVM_CLASSPATH}${SEP}../h2o-core/build/resources/test${SEP}../h2o-core/build/resources/main"
JVM_CLASSPATH="${JVM_CLASSPATH}${SEP}../h2o-test-support/build/classes/java/main"
JVM_CLASSPATH="${JVM_CLASSPATH}${SEP}../h2o-test-support/build/resources/main"

# Include any .jar files
JVM_CLASSPATH="${JVM_CLASSPATH}${SEP}$(find ../lib -name '*.jar' 2>/dev/null | paste -sd${SEP} -)"
JVM_CLASSPATH="${JVM_CLASSPATH}${SEP}$(find build/libs -name '*.jar' 2>/dev/null | paste -sd${SEP} -)"
