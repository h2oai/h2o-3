  ...
  private class InfogramDriver extends Driver {
    ...
    public final void buildModel() {
      try {
        ...
        _model._output.extractAdmissibleFeatures(_varImp, _model._output._all_predictor_names, _cmi, _cmiRaw,
                _parms._cmi_threshold, _parms._relevance_threshold, false, false);
        if (validPresent) {
          _cmiRelKeyValid = _model._output._relevance_cmi_key_valid;
          _model._output.extractAdmissibleFeatures(_varImp, _model._output._all_predictor_names_valid, _cmiValid, 
                  _cmiRawValid, _parms._cmi_threshold, _parms._relevance_threshold, true, false);
        ...
        if (_cvDone) {                       // CV is enabled and now we are in main model
          ...
          _model._output.extractAdmissibleFeatures(_varImp, _model._output._all_predictor_names_valid, _cmiValid, 
                  _cmiRawValid, _parms._cmi_threshold, _parms._relevance_threshold, false, true);
