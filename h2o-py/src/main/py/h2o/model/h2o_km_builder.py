...
class H2OKMeansBuilder(H2OModelBuilder):
    ...
    def __init__(self, x=None, k=5, training_frame=None, key=None, max_iterations=1000,
        ...
        :param init: How to select initial set of cluster points. Random for random initialization, Furthest 
                     for initialization at furthest point from successive centers, and PlusPlus for k-means++.
