...
class H2OGeneralizedLinearEstimator(H2OEstimator):
    ...
    def solver(self):
        ...
        One of: ``"auto"``, ``"irlsm"``, ``"irlsm_speedup"``, ``"irlsm_speedup2"``, ``"irlsm_speedup_no_admm"``,
        ``"l_bfgs"``, ``"coordinate_descent_naive"``, ``"coordinate_descent"``, ``"gradient_descent_lh"``,
        ``"gradient_descent_sqerr"``  (default: ``"auto"``).
        """
        return self._parms.get("solver")

    @solver.setter
    def solver(self, solver):
        assert_is_type(solver, None, Enum("auto", "irlsm", "irlsm_speedup", "irlsm_speedup2", "irlsm_speedup_no_admm", "l_bfgs", "coordinate_descent_naive", "coordinate_descent", "gradient_descent_lh", "gradient_descent_sqerr"))
