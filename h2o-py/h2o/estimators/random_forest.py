...
class H2ORandomForestEstimator(H2OEstimator):
  """Builds a Random Forest Model on an H2OFrame
    ...
    histogram_type : str
      ...
      Can be one of "AUTO", "UniformAdaptive", "Random", "QuantilesGlobal" or "RoundRobin". Note that
      H2O supports extremely randomized trees with the "Random" option. 
    """
  def __init__(self, model_id=None, mtries=None, col_sample_rate_change_per_level=None,
               ...
               checkpoint=None, min_split_improvement=None, histogram_type=None):
