...
class H2ORandomForestEstimator(H2OEstimator):
    ...
    def __init__(self, model_id=None, training_frame=None, validation_frame=None, nfolds=0, keep_cross_validation_models=True,
                 ...
                 max_confusion_matrix_size=20, ntrees=50, max_depth=20, min_rows=1, nbins=20, nbins_top_level=1024,
                 nbins_cats=1024, r2_stopping=None, stopping_rounds=0, stopping_metric="auto", stopping_tolerance=0.001,
                 max_runtime_secs=0, seed=-1, build_tree_one_node=False, mtries=-1, sample_rate=0.632,
                 sample_rate_per_class=None, binomial_double_trees=False, checkpoint=None,
                 col_sample_rate_change_per_level=1, col_sample_rate_per_tree=1, min_split_improvement=1e-05,
                 histogram_type="auto", categorical_encoding="auto", calibrate_model=False, calibration_frame=None,
                 distribution="auto", custom_metric_func=None, export_checkpoints_dir=None,
                 check_constant_response=True, gainslift_bins=-1, auc_type="auto"):
        """
        ...
        :param int mtries: Number of variables randomly sampled as candidates at each split. If set to
               -1, defaults to sqrt{p} for classification and p/3 for regression (where p is the # of predictors
               (default: -1).
        ...
        :param bool binomial_double_trees: For binary classification: Build 2x as many trees (one per
               class) - can lead to higher accuracy. (default: False).
