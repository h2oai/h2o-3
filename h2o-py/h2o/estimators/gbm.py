...
class H2OGradientBoostingEstimator(H2OEstimator):
    ...
    def __init__(self, model_id=None,
        ...
        :param float learn_rate_annealing: Scale the learning rate by this factor after each tree (e.g., 0.99 or 0.999)
               (default:1).
        :param Enum["auto", "bernoulli", "quasibinomial", "multinomial", "gaussian", "poisson", "gamma", "tweedie",
               "laplace", "quantile", "huber", "custom"] distribution: Distribution function (default:"auto").
        ...
        :param float pred_noise_bandwidth: Bandwidth (sigma) of Gaussian multiplicative noise ~N(1,sigma) for tree node
        ...
        :param str custom_metric_func: Reference to custom evaluation function, format: `language:keyName=funcName`
               (default:None).
        :param str custom_distribution_func: Reference to custom distribution, format: `language:keyName=funcName`
               (default:None).
