...
class H2OGradientBoostingEstimator(H2OEstimator):
    ...
    def __init__(self,
                 ...
                 distribution="auto",  # type: Enum["auto", "bernoulli", "quasibinomial", "multinomial", "gaussian", "poisson", "gamma", "tweedie", "laplace", "quantile", "huber", "custom"]
        ...
        :type distribution: Enum["auto", "bernoulli", "quasibinomial", "multinomial", "gaussian", "poisson", "gamma", "tweedie",
               "laplace", "quantile", "huber", "custom"], optional
