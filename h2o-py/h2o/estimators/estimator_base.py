...
class H2OEstimator(ModelBase):
    ...
    def _train(self, x=None, y=None, training_frame=None, offset_column=None, fold_column=None,
        ...
        is_supervised = not(is_auto_encoder or algo in {"aggregator", "pca", "svd", "kmeans", "glrm", "word2vec", "isolationforest", "mojodelegating"})
        ...
        if not is_unsupervised and y is None and self.algo not in ["mojodelegating"]: raise ValueError("Missing response")
