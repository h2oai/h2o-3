...
class H2OAnomalyDetectionModel(ModelBase):
    ...
    def varsplits(self, use_pandas=False):
        ...
        - count - number of times a variable was used to make a split.
        - aggregated_split_ratios - split ratio is defined as "abs(#left_observations - #right_observations) / #before_split"
        ...
        - aggregated_split_depths - sum of all depths of a variable used to make a split (if a variable is used
