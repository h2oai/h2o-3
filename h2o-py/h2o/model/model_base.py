...
class ModelBase(h2o_meta(Keyed)):
    ...
    def auuc(self, train=False, valid=False):
        ...
        :param bool train: If ``train=True``, then return the AUUC value for the training data.
        :param bool valid: If ``valid=True``, then return the AUUC value for the validation data.
    ...
    def auuc_normalized(self, train=False, valid=False):
        ...
        If all are ``False`` (default), then return the training metric value.
        If more than one option is set to ``True``, then return a dictionary of metrics where the keys are "train", "valid".
    ...
    def auuc_table(self, train=False, valid=False):
        ...
        :param bool train: If ``train=True``, then return the AUUC table value for the training data.
        :param bool valid: If ``valid=True``, then return the AUUC table value for the validation data.
    ...
    def qini(self, train=False, valid=False):
        ...
        :param bool train: If ``train=True``, then return the Qini value for the training data.
        :param bool valid: If ``valid=True``, then return the Qini value for the validation data.
