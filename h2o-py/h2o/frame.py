...
class H2OFrame(object):
    ...
    def categories(self):
        ...
        fr = H2OFrame._expr(expr=ExprNode("unique", self))
        #Convert into a list
        cat_list = fr.as_data_frame(use_pandas=False)[1:]
        #Flatten out the list and return
        return [val[0] for val in cat_list]
