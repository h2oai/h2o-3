...
def create_frame(frame_id=None, rows=10000, cols=10, randomize=True, value=0, real_range=100,
    ...
    parms = {"dest": py_tmp_key(append=h2oconn.session_id) if frame_id is None else frame_id,
             "rows": rows,
             "cols": cols,
             "randomize": randomize,
             "value": value,
