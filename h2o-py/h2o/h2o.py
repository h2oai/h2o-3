...
def create_frame(id=None, rows=10000, cols=10, randomize=True, value=0, real_range=100,
    ...
    Creates a data frame in H2O with real-valued, categorical, integer, and binary columns
    ...
    ----------
      ...
      randomize : bool
        A logical value indicating whether data values should be randomly generated. This
        must be TRUE if either categorical_fraction or integer_fraction is non-zero.
      ...
      has_response : bool
        A logical value indicating whether an additional response column should be pre-pended
        to the final H2O data frame. If set to TRUE, the total number of columns will be cols+1.
