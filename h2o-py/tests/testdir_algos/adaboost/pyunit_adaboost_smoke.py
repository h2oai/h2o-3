...
def adaboost():
    ...
    adaboost_model = H2OAdaBoostEstimator(n_estimators=50, seed=0xBEEF, weak_learner="DRF", learning_rate=0.5)
    ...
    assert 0.5 == adaboost_model._model_json["output"]["model_summary"]["learning_rate"][0], "Python API is not working!"
