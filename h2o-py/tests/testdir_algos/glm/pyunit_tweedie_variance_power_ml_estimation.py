...
def test_tweedie_var_power_estimation_1p2_phi_2_no_link_power_est():
    ...
    assert abs(model_ml.actual_params["tweedie_variance_power"] - 1.2700088668231333) < 0.001
...
def test_tweedie_var_power_estimation_2p5_phi_2p5_no_link_power_est():
    ...
    assert abs(model_ml.actual_params["tweedie_variance_power"] - 2.560363817583382) < 0.001
