...
def init_err_casesKmeans():
  ...
  for x in ["NA", "NaN", "Inf", "-Inf"]:
    ...
    H2OKMeansEstimator(k=3, user_points=h2o.H2OFrame(start_err)).train(x=list(range(numcol)), training_frame=benign_h2o)
  ...
  H2OKMeansEstimator(k=3, user_points=h2o.H2OFrame(start)).train(x=list(range(numcol)), training_frame=benign_h2o)
