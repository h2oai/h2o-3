...
def init_err_casesKmeans():
    ...
    start_small = [[random.gauss(0,1) for c in range(5)] for r in range(numcol-2)]
    start_large = [[random.gauss(0,1) for c in range(5)] for r in range(numcol-2)]
    ...
    start = [[random.gauss(0,1) for c in range(numrow+2)] for r in range(numcol)]
    try:
    ...
    start = [[random.gauss(0,1) for c in range(3)] for r in range(numcol)]
