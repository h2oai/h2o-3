...
def test_cv_warning_messages():
    """
    In this test, I will enable cv, add weights to training dataset but do not add weights to the validation
    dataset.  There should be warning in this case about the missing weight columns.
    """
