...
from tests.pyunit_utils import CustomMaeFunc, CustomRmseRegressionFunc
...
if __name__ == "__main__":
    pyunit_utils.run_tests([grid_custom_metrics, grid_custom_metric, grid_custom_metrics_parallel])
else:
    grid_custom_metric()
