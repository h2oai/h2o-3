...
def glrm_unitonesparse():
    ...
    glrm_h2o = h2o.glrm(x=train_h2o, k=k, init="User", user_points=initial_y_h2o, loss="Quadratic", regularization_x="UnitOneSparse", regularization_y="None", gamma_x=1, gamma_y=0)
    glrm_h2o.show()
