...
def test_scoring_history_model_summary():
    h2o_data = h2o.import_file(path=pyunit_utils.locate("smalldata/hglm_test/gaussian_0GC_123R_all5Enum_p5oise_p08T_wIntercept_standardize.gz"))
    ...
    hglm_model = hglm(random_columns=random_columns, group_column = "C1", score_each_iteration=True, seed=12345,
                      max_iterations = 10, random_intercept = True, standardize=False)
