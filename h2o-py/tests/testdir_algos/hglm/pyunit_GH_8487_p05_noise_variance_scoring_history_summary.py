...
def test_scoring_history_model_summary():
    h2o_data = h2o.import_file(path=pyunit_utils.locate("smalldata/hglm_test/gaussian_0GC_678R_6enum_5num_p05oise_p08T_woIntercept_standardize.gz"))
