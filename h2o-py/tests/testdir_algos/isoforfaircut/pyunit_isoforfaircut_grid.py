...
def grid_search_fcf():
    ...
    fcf_grid = H2OGridSearch(H2OFairCutForestEstimator, hyper_params=grid_space)
    fcf_grid.train(training_frame=train)

    print("Check correct type value....")
    model_type = fcf_grid[0].type
...
if __name__ == "__main__":
    pyunit_utils.standalone_test(grid_search_fcf)
else:
    grid_search_fcf()
