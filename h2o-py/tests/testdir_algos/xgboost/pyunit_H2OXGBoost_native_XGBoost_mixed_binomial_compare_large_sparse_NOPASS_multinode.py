...
def comparison_test_dense():
    ...
    h2oParamsS = {"ntrees":ntrees, "max_depth":maxdepth, "seed":runSeed, "learn_rate":0.7, "col_sample_rate_per_tree" : 0.9,
    ...
    print("Summarizing H2OXGBoost and native XGBoost result with Dmatrix=dense.")
    ...
    print("Summarizing H2OXGBoost and native XGBoost result with Dmatrix=sparse.")
