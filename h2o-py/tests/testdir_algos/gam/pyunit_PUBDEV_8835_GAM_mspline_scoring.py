...
def tes_gam_mSpline_coeffs():
    ...
    predict_frame = h2o.import_file("http://h2o-public-test-data.s3.amazonaws.com/smalldata/gam_test/gaussian_mspline_glm_predict.csv")
    gamX = ["C11", "C12", "C13"]
    x = train1.names
    x.remove("C21")
    ...
    predict_frame = h2o.import_file("http://h2o-public-test-data.s3.amazonaws.com/smalldata/gam_test/binomial_mspline_glm_predict.csv")
...
if __name__ == "__main__":
    pyunit_utils.standalone_test(tes_gam_mSpline_coeffs)
else:
    tes_gam_mSpline_coeffs()
