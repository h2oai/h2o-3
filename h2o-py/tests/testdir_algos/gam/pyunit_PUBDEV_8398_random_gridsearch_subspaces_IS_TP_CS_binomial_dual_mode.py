...
def test_randomdiscrete_gridsearch():
    ...
    hyper_parameters = {'lambda': [1, 2],
                        'subspaces': [{'scale': [[0.001], [0.0002]], 'num_knots': [[5], [10]], 'bs':[[1], [0]], 
                                       'gam_columns': [[["c_0"]], [["c_1"]]]},
                                      {'scale': [[0.001, 0.001, 0.001, 0.001], [0.0002, 0.0002, 0.0002, 0.0002]], 
                                       'bs':[[0, 1, 2, 1], [2, 1, 0,1]], 
                                       'num_knots': [[5, 10, 12, 12], [6, 11, 13, 13]], 
                                       'gam_columns': [[["c_0"], ["c_1", "c_2"],["c_2"], ["c_3", "c_4", "c_5"]],
                                                   [["c_1"], ["c_2", "c_3"],["c_3"], ["c_4", "c_5", "c_6"]]]}]}
