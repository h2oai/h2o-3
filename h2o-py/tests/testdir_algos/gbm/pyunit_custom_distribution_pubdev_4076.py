...
from tests.pyunit_utils import CustomDistributionGaussian, CustomDistributionGaussianWrong, \
    CustomDistributionBernoulli, CustomDistributionMultinomial
...
def custom_distribution_bernoulli():
    return h2o.upload_custom_distribution(CustomDistributionBernoulli, func_name="custom_binomial",
...
def test_custom_metric_computation_regression():
    ...
    (model8, f_test8) = regression_model_distribution(H2OGradientBoostingEstimator, custom_distribution_gaussian())
