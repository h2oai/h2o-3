...
def test_predict_staged_proba():
    ...
    staged_preds = prostate_gbm_50.predict_staged_proba(prostate)
...
if __name__ == "__main__":
    pyunit_utils.standalone_test(test_predict_staged_proba)
else:
    test_predict_staged_proba()
