...
from tests.pyunit_utils import CustomDistributionGaussian
...
def custom_distribution_mojo_test():
    rows = 2000
    df = random_dataset('regression', verbose=False, NTESTROWS=rows)
    ...
    params = {
              ...
              'max_depth': 4, 
              'distribution': "custom",
              'custom_distribution_func': custom_distribution_gaussian()
              }
    ...
    compare_frames_local(pred_h2o, pred_mojo)
