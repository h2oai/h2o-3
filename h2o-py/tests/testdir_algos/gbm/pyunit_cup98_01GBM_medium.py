...
def cupMediumGBM():
  ...
  train = h2o.import_frame(path=pyunit_utils.locate("bigdata/laptop/usecases/cup98LRN_z.csv"))

  test = h2o.import_frame(path=pyunit_utils.locate("bigdata/laptop/usecases/cup98VAL_z.csv"))
