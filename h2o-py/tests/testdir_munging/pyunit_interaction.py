...
def interaction_check(ip,port):
    ...
    levels1 = [i[0] for i in two_way_interactions[0].levels()]
    levels2 = [i[0] for i in two_way_interactions[1].levels()]
    levels3 = [i[0] for i in two_way_interactions[2].levels()]
