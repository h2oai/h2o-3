...
def to_H2OFrame():
    ...
    #   pyunit_utils.check_dims_values(python_obj, the_frame, rows=5, cols=1) TODO

    #   b. single column
    python_obj = [[1], [2], [3.7], [8], [9]]
    the_frame = h2o.H2OFrame(python_obj)
    print "Row number and column number is ",(the_frame.nrow,the_frame.ncol)
    sys.stdout.flush()
    ...
    python_obj = [["a", "b"], ["c", "d"]]
    the_frame = h2o.H2OFrame(python_obj)
    #    pyunit_utils.check_dims_values(python_obj, the_frame, rows=2, cols=2) TODO
