...
def expr_math_ops(ip,port):
    ...
    num_val = math.gamma(h2o_data3[5,5].eager())
    ...
    num_val = math.lgamma(h2o_data3[5,5].eager())
    assert abs(h2o_val - num_val) < max(abs(h2o_val), abs(num_val)) * 1e-6, \
    ...
    num_val = scipy.special.polygamma(0,h2o_data3[5,5].eager())
    assert abs(h2o_val - num_val) < max(abs(h2o_val), abs(num_val)) * 1e-6, \
    ...
    num_val = scipy.special.polygamma(1,h2o_data3[5,5].eager())
    assert abs(h2o_val - num_val) < max(abs(h2o_val), abs(num_val)) * 1e-6, \
