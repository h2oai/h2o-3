...
def multi_dim_slicing(ip,port):
    ...
    pros = prostate[47,7]
    assert pros.eager() == 16.3, "Incorrect slicing result"
    ...
    assert pros[0,1].eager() == 1, "Incorrect slicing result"
    ...
    assert pros[0,2].eager() == 1, "Incorrect slicing result"
    assert pros[1,0].eager() == 0, "Incorrect slicing result"
    assert pros[1,1].eager() == 75, "Incorrect slicing result"
    assert pros[1,2].eager() == 1, "Incorrect slicing result"
    assert pros[2,0].eager() == 1, "Incorrect slicing result"
