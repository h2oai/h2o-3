...
def pub_445_long_request_uri():
    ...
    mnistTrain = h2o.import_frame(path=pyunit_utils.locate("bigdata/laptop/mnist/train.csv.gz"))

    mnistTest = h2o.import_frame(path=pyunit_utils.locate("bigdata/laptop/mnist/train.csv.gz"))
