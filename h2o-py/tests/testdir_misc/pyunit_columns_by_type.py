...
def pyunit_columns_by_types():
    ...
    cat_type = fr.columns_by_type(type="categorical")
    str_type = fr.columns_by_type(type="string")
    time_type = fr.columns_by_type(type="time")
    uuid_type = fr.columns_by_type(type="uuid")
    bad_type = fr.columns_by_type(type="bad")
