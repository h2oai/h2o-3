...
def test_column_skip_high_cardinality():
  # generate a big frame with all datatypes and save it to csv.
    ...
    file1 = h2o.upload_file(savefilenamewithpath, col_types = ["enum", "int"], force_col_types=True)
    file2 = h2o.import_file(savefilenamewithpath, col_types = ["enum", "int"], force_col_types=True)
  
    # try:
    #     h2o.upload_file(savefilenamewithpath, col_types=["enum","int"], force_col_types=True)
