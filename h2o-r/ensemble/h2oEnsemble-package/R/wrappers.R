...
h2o.gbm.wrapper <- function(x, y, training_frame, model_id = NULL, # TO DO: add checkpoint?
                            ignore_const_cols = TRUE,
...
h2o.randomForest.wrapper <- function(x, y, training_frame, model_id = NULL,
                                     validation_frame = NULL,
                                     ignore_const_cols = TRUE, # TO DO: checkpoint?
                                     ...
                                     min_rows = 1, 
                                     nbins = 20,
                                     nbins_top_level,  # TO DO: Add default
                                     nbins_cats = 1024, 
