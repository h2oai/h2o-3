...
#'        (a time-based random number will be generated). The type is long, however, R cannot handle long number correctly, so the type can also be a string.
#'        (For example autogenerated seed -8664354335142703762 has to be passed as string "-8664354335142703762"). Defaults to -1.
