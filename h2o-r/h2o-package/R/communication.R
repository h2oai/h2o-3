...
# The problem is when users create a model without seed in R, they are not able to get correct seed autogenerated from Java, 
# because it is in format, which can't be used in R without loss. 
# For example h2o generates -8664354335142703762 but in R user the number changes to -8664354335142704128,
# so this number should be read and pass as string in R. 
