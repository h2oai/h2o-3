...
#' @param allowed_interaction_pairs A list of allowed pairwise column interactions.
...
h2o.xgboost <- function(x,
                        ...
                        allowed_interaction_pairs = NULL,
                        ...
                        verbose = FALSE)
{
  ...
  if (!missing(allowed_interaction_pairs))
    parms$allowed_interaction_pairs <- allowed_interaction_pairs
