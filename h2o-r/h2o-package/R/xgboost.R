...
#' @param include_interaction_pairs A list of allowed pairwise column interactions.
...
h2o.xgboost <- function(x,
                        ...
                        include_interaction_pairs = NULL,
                        ...
                        verbose = FALSE)
{
  ...
  if (!missing(include_interaction_pairs))
    parms$include_interaction_pairs <- include_interaction_pairs
