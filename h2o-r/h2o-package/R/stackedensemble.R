...
#' 
#' Build a stacked ensemble (Super Learner) using the H2O base
...
#' @param base_models Vector of model ids which we can stack together.  Models must have been cross-validated using \code{nfolds>1} and they all must use the same cross-validation folds.
#' @param selection_strategy Strategy for choosing which models to stack. Only one strategey currently implemented: "choose_all".
