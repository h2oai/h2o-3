...
#' @param metalearner_transform Transformation used for the level one frame. Must be one of: "NONE", "Logit", "PercentileRank". Defaults to
#'        NONE.
...
h2o.stackedEnsemble <- function(x,
                                ...
                                metalearner_transform = c("NONE", "Logit", "PercentileRank"),
                                max_runtime_secs = 0,
                                weights_column = NULL,
                                offset_column = NULL,
                                seed = -1,
