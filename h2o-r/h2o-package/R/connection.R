...
#'
#' Arguments \code{ip} and \code{port} can be configured by environment variables \code{H2O.IP} and \code{H2O.PORT}.
#'
...
#' }
#' @export
h2o.init <- function(ip = Sys.getenv("H2O.IP", "localhost"), port = as.integer(Sys.getenv("H2O.PORT", 54321)),
