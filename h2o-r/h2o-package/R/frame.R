...
#'                       E.g., If method is "lo", then it will take the lo value of the quantile.
#' @param ... Further arguments passed to or from other methods.
...
quantile.H2OFrame <- function(x,
                     ...
                     combine_method = c("interpolate", "avg", "lo", "hi"),
                     ...)
{
  ...
  if( length(combine_method) > 1 ) combine_method <- combine_method[1]
  if( !(combine_method %in% c("interpolate", "avg", "lo", "hi")) ) stop( paste0("Combine method not found: ", combine_method) )
