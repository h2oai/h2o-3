...
#' @param x TODD
#' @param y TODD
#' @param fold_column TODD
#' @export
h2o.target_encode_fit <- function (fr, x, y, fold_column)
{
...
#'
#' @param encoding_map TODD
#' @param is_train_or_valid TODD
#' @param frame TODD
#' @param x TODD
#' @param y TODD
#' @param holdout_type TODD
#' @param blending TODD
#' @param inflection_point TODD
#' @param smoothing TODD
#' @param noise TODD
#' @param seed TODD
#' @export
h2o.target_encode_transform <- function (encoding_map=NULL, fold_column, is_train_or_valid=NULL, frame=NULL, x, y, holdout_type=c("kfold", "loo", "none"), blending=NULL, inflection_point=NULL, smoothing=NULL, noise = -1, seed = -1)
{
    if(missing(fold_column)) {
        fold_column_name <- ""
    } else {
