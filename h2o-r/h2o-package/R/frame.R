...
##`         .force.eval(x, ID = ID, rID = 'x')                                # call the force eval
...
#
#  res = .h2o.__remoteSend(.h2o.__PAGE_SUMMARY2, source=data@id, max_ncols=.Machine$integer.max)
...
setMethod("summary", "H2OFrame", function(object, factors=6L, ...) {
  ...
  cols <- sapply(cnames, function(col) {
    col.rest <- .h2o.__remoteSend(.h2o.__COL_SUMMARY(object@id, col), method = "GET")
