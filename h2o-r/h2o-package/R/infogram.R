...
#' @param total_information_threshold A number between 0 and 1 representing a threshold for total information.  For a specific feature, if the total
...
#'        the x-axis of the Core Infogram.  Defaults to 0.1.
#' @param net_information_threshold A number between 0 and 1 representing a threshold for net information.  For a specific feature, if the net
...
#'        the Core Infogram. Defaults to 0.1.
#' @param relevance_index_threshold A number between 0 and 1 representing a threshold for the relevance index.  This is only used when
...
#'        feature will be considered admissible.  The relevance index is the x-axis of the Fair Infogram. Defaults to
#'        0.1.
#' @param safety_index_threshold A number between 0 and 1 representing a threshold for the safety index.  This is only used when
#'        protected_columns is set by the user.  For a specific feature, if the safety index value is higher than this
#'        threshold, and the corresponding relevance index is also higher than the relevance_index_threshold, that
#'        feature will be considered admissible.  The safety index is the y-axis of the Fair Infogram. Defaults to 0.1.
#' @param data_fraction The fraction of training frame to use to build the infogram model. Any value greater than 0 and less than or
#'        equal to 1.0 is acceptable. Defaults to 1.
