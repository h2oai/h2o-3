...
#' The H2ONode class.
#'
#' This class represents a single node in an \code{H2OTree}. 
...
#' @slot left_child A \code{H2ONode} representing the left child node, if a node has one.
#' @slot right_child A \code{H2ONode} representing the right child node, if a node has one.
...
setClass(
  ...
  representation(
    id = "integer",
    threshold = "numeric",
    left_child = "H2ONodeOrNULL",
    right_child = "H2ONodeOrNULL",
