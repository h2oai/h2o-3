...
#' @param user_splits A two level nested lists containing user defined split-points for pdp plots for each column.
#'        If there are two columns using user defined split points, there should be two lists in the nested list.
#'        Inside each list, the first element is the column name followed by values defined by user.
