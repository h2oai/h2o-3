...
#' @param path Path where to save the output in .xlsx format (e.g. "/mypath/file.xlsx"). Please note
#'        that Pandas and XlsxWriter need to be installed for using this option. Defaults to None.
#'
#' @examples
#' \dontrun{
#' library(h2o)
