    ...
    if (type == "H2OModel")
      ...
      if (name == "seed") {
        if(is.character(paramValue) && !.is.int64(paramValue))
          ...
          } else if(nchar(toString(paramValue)) > 16) {
            warning("The seed has maximum number of digits which can be used in R as a number. 
              The R cannot handle correctly larger numbers than 16 digits. 
