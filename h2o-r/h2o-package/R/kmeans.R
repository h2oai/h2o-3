...
h2o.kmeans <- function(data, cols, # AUTOGENERATED PARAMETERS:
  ...
  res <- .h2o.__remoteSend(data@h2o, .h2o.__KMEANS_PARAMS)
...
#  parms <- .addStringParm(parms, k = "destination_key", v = if(!missing(key)) key else default_params$"destination_key" )
  ...
  res <- .h2o.__remoteSend(data@h2o, method = "POST", .h2o.__KMEANS_PARAMS, .params = parms)
...
#  return(res_model)
  ...
  new("H2OKMeansModel", h2o = data@h2o, key = dest_key, data = data, model = model_output, valid = new("H2OParsedData", h2o=data@h2o, key="NA"))
  }