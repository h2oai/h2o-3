...
#'
#' Performs Deep Learning neural networks on an H2O H2OFrame
#'
...
#' @param validation_frame An H2O H2OFrame object indicating the validation dataset used to construct the confusion matrix. Defaults to NULL.  If left as NULL, this defaults to the training data when \code{nfolds = 0}.
                             ...
                             keep_cross_validation_predictions = FALSE)
{
  ...
  # Training_frame and validation_frame may be a key or an H2O H2OFrame object
...
#' @return Returns an H2O H2OFrame object containing the
...
#' @return Returns an H2O H2OFrame object with as many features as the
