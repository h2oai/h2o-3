...
)
{
  ...
  # if ( !(missing(validation_frame)) ) parms$validation_frame <- validation_frame@key
  # else parms$validation_frame <- ""
  # parms$expert_mode <- TRUE #always enable expert mode from R
  parms$do_classification <- TRUE #hard-code classification until regression
