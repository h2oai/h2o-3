...
function() {
  ...
  to_src <- c("astfun.R", "classes.R", "config.R", "connection.R", "constants.R", "logging.R", "communication.R",
              ...
              "parse.R", "export.R", "models.R", "edicts.R", "coxph.R", "coxphutils.R", "glm.R", "gam.R", "anovaglm.R",
              "glrm.R", "pca.R", "kmeans.R", "gbm.R", "deeplearning.R", "naivebayes.R", "randomforest.R", "svd.R", 
              "locate.R", "predict.R", "rulefit.R", "isolationforest.R", "psvm.R", "tf-idf.R")
