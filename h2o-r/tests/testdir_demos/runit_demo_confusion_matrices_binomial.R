...
function () {
    ...
    air <- h2o.importFile(path=locate("smalldata/airlines/AirlinesTrain.csv.zip"))
    ...
    # Test dataset
    air.test <- h2o.importFile(path=locate("smalldata/airlines/AirlinesTest.csv.zip"))
