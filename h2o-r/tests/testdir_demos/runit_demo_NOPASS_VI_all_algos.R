...
my.glm <- h2o.glm(x=myX, y=myY, training_frame=data.hex, family="binomial",standardize=T,use_all_factor_levels=T,lambda_search=T,return_all_lambda=T,variable_importances=T)
