...
test_columns_by_type <- function() {
    ...
    cat_type = h2o.columns_by_type(fr,type="categorical")
    str_type = h2o.columns_by_type(fr,type="string")
    time_type = h2o.columns_by_type(fr,type="time")
    uuid_type = h2o.columns_by_type(fr,type="uuid")
    bad_type = h2o.columns_by_type(fr,type="bad")
