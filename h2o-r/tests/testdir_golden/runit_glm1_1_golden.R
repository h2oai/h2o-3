...
Log.info(paste("H2O Deviance  : ", fitH2O@model$training_metrics$residual_deviance))
Log.info(paste("H2O Null Dev  : ", fitH2O@model$training_metrics$null_deviance))
expect_false(fitH2O@model$training_metrics$null_deviance=="NaN")
testEnd()
}
