...
test.glrmstand.golden <- function(H2Oserver) {
  # Import data: 
  ...
  fitH2O <- h2o.glrm(arrestsH2O, k = 4, gamma = 0, init = "PlusPlus", transform = "STANDARDIZE")
...
doTest("GLRM Golden Test: USArrests with Standardization", test.glrmstand.golden)