...
src <-
function(ROOT.PATH) {
  to_src <- c("/classes.R", "/wrapper.R", "/constants.R", "/logging.R", "/h2o.R", "/kvstore.R", "/exec.R", "/ops.R", "/methods.R", "/ast.R", "/astfun.R", "/import.R", "/parse.R", "/export.R", "/models.R", "/edicts.R", "/gbm.R", "/kmeans.R", "/deeplearning.R")
