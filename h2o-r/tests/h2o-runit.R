...
src <-
function(ROOT.PATH) {
  to_src <- c("/wrapper.R", "/constants.R", "/logging.R", "/h2o.R", "/exec.R", "/classes.R", "/ops.R", "/methods.R", "/ast.R", "/import.R", "/parse.R", "/export.R", "/models.R", "/edicts.R", "/algorithms.R", "/predict.R", "/kmeans.R")
