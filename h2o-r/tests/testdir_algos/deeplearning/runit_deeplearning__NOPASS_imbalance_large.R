...
check.deeplearning_imbalanced <- function(conn) {
  ...
  class_6_err_imbalanced <- hh_imbalanced@model$errors$train_confusion_matrix$'_classErr'[6]
  class_6_err_balanced <- hh_balanced@model$errors$train_confusion_matrix$'_classErr'[6]
