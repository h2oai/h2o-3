...
check.deeplearning_imbalanced <- function(conn) {
  ...
  hh_imbalanced=h2o.deeplearning(x=c(1:54),y=55,l1=1e-5,activation="Rectifier",hidden=c(200,200,200),epochs=5,training_frame=covtype,balance_classes=F)
  print(hh_imbalanced)
  hh_balanced=h2o.deeplearning(x=c(1:54),y=55,l1=1e-5,activation="Rectifier",hidden=c(200,200,200),epochs=5,training_frame=covtype,balance_classes=T)
  print(hh_balanced)
