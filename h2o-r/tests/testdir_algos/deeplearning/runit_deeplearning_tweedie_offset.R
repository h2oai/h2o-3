...
test <- function() {
  ...
  print(min(ph[,1]))
  print(max(ph[,1]))
	expect_equal(0.5616414,mean_deviance, 1e-2)
	expect_equal(47.6147, mean(ph[,1]), 1e-2)
	expect_equal(1.904093, min(ph[,1]), 1e-1 )
	expect_equal(280.7351, max(ph[,1]), 1e-1 )
  ...
  print(min(ph[,1]))
  print(max(ph[,1]))
	expect_equal(0.2610655,mean_deviance, 1e-2)
	expect_equal(49.2939, mean(ph[,1]), 1e-2 )
	expect_equal(1.073911, min(ph[,1]), 1e-1 )
	expect_equal(397.3288, max(ph[,1]), 1e-1 )
