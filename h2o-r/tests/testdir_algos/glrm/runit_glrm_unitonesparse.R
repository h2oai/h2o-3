...
test.glrm.unitonesparse <- function() {
  ...
  h2oTest.logInfo("Run GLRM with unit one-sparse regularization on X")
  ...
  h2oTest.logInfo("Check that X matrix consists of rows of basis vectors")
...
h2oTest.doTest("GLRM Test: Unit One-sparse K-means Implementation", test.glrm.unitonesparse)
