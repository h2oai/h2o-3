...
test.pubdev.1725 <- function() {
  ...
  fitH2O_pp <- h2o.glrm(cancar.hex, k = 4, transform = "NONE", init = "PlusPlus", loss = "Quadratic", gamma_x = 0, gamma_y = 0, max_iterations = 1000)
  ...
  fitH2O_svd <- h2o.glrm(cancar.hex, k = 4, transform = "NONE", init = "SVD", loss = "Quadratic", gamma_x = 0, gamma_y = 0, max_iterations = 1000)
