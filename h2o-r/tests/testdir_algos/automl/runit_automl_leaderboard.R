...
automl.leaderboard.suite <- function() {
    ...
    test.custom_leaderboard <- function() {
        ...
        expect_equal(names(h2o.get_leaderboard(aml, extensions=c("predict_time_per_row_ms","training_time_ms"))), c(std_columns, "predict_time_per_row_ms", "training_time_ms"))
        expect_equal(names(h2o.get_leaderboard(aml, extensions=list("unkown","training_time_ms"))), c(std_columns, "training_time_ms"))
