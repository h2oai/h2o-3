...
#	pr = exp(pr+log(Insurance$Holders)) 
	...
	hh = h2o.gbm(x = 1:3,y = "Claims",distribution ="gamma",ntrees = 600,max_depth = 1,min_rows = 1,learn_rate = .1,offset_column = "offset",training_frame = hdf,min_split_improvement=0) 
