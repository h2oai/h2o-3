...
test.gbm.imbalanced <- function() {
  ...
  hh_balanced  <-h2o.gbm(x=c(1:54),y=55,ntrees=10,min_rows=5,learn_rate=0.2,training_frame=covtype,distribution="multinomial",balance_classes=T, seed=3) #seed is used for (over-)sampling to obtain class balance
