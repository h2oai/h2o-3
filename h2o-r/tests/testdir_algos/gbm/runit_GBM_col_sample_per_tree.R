...
test.gbm.colsamplepertree <- function() {
  ...
  regular      <- h2o.gbm(x=1:54,y=55,ntrees=50,seed=1234,training_frame=train)
  colsample    <- h2o.gbm(x=1:54,y=55,ntrees=50,seed=1234,training_frame=train,col_sample_rate_per_tree=0.9)
  ...
  expect_true(err_regular >= err_colsample, "col sampling made validation error worse!")
}
