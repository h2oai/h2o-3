...
test.GBM <- function(conn) {
  ...
  train.hex <- h2o.uploadFile(conn, locate("bigdata/laptop/usecases/cup98LRN_z.csv"), key="cup98LRN_z.hex")
  test.hex  <- h2o.uploadFile(conn, locate("bigdata/laptop/usecases/cup98VAL_z.csv"), key="cup98VAL_z.hex")
