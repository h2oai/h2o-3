...
check.gbm.grid.cars <- function() {
  ...
  grid_space = h2oTest.makeRandomGridSpace(algo="gbm")
  ...
  h2oTest.logInfo("Constructing the new grid of gbm models...")
  if ( validation_scheme == 1 ) {
...
h2oTest.doTest("GBM Grid Search using cars dataset", check.gbm.grid.cars)
