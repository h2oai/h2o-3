...
test.gbm.mult.accessors <- function(conn) {
  ...
  print(mse.basic)
  expect_error(h2o.mse(iris.gbm, valid = TRUE))
  ...
  print(r2.basic)
  expect_error(h2o.r2(iris.gbm, valid = TRUE))
  ...
  print(ll.basic)
  expect_error(h2o.logloss(iris.gbm, valid = TRUE))
  ...
  print(hrt.basic)
  expect_error(h2o.hit_ratio_table(iris.gbm, valid = TRUE))
