...
test.GBM.contribs_sorted <- function() {
    ...
    expect_equal("GLEASON", contributions[1,1], info="Not sorted correctly")
    expect_equal("PSA", contributions[1,3], info="Not sorted correctly")

    contributions <- as.data.frame(h2o.predict_contributions(gbm_model, first_row, top_n=2, top_bottom_n=2, abs=FALSE))
    expect_equal("VOL", contributions[1,1], info="Not sorted correctly")
    expect_equal("RACE", contributions[1,3], info="Not sorted correctly")
    expect_equal("GLEASON", contributions[1,5], info="Not sorted correctly")
    expect_equal("PSA", contributions[1,7], info="Not sorted correctly")
    ...
    expect_equal("RACE", contributions[1,1], info="Not sorted correctly")
    expect_equal("DCAPS", contributions[1,3], info="Not sorted correctly")

    contributions <- as.data.frame(h2o.predict_contributions(gbm_model, first_row, top_n=2, top_bottom_n=2, abs=TRUE))
    expect_equal("GLEASON", contributions[1,1], info="Not sorted correctly")
    expect_equal("PSA", contributions[1,3], info="Not sorted correctly")
    expect_equal("RACE", contributions[1,5], info="Not sorted correctly")
    expect_equal("DCAPS", contributions[1,7], info="Not sorted correctly")
...
checkSortedCorrectly <- function (contributions) {
    ...
    expect_equal("DPROS", contributions[1,7], info="Not sorted correctly")
    expect_equal("AGE", contributions[1,9], info="Not sorted correctly")
    expect_equal("PSA", contributions[1,11], info="Not sorted correctly")
    expect_equal("GLEASON", contributions[1,13], info="Not sorted correctly")
}

checkSortedCorrectlyReverse <- function (contributions) {
    expect_equal(dim(contributions), c(1,15), info="Output frame has wrong dimmension")
    expect_equal("VOL", contributions[1,13], info="Not sorted correctly")
    expect_equal("RACE", contributions[1,11], info="Not sorted correctly")
    expect_equal("DCAPS", contributions[1,9], info="Not sorted correctly")
    expect_equal("DPROS", contributions[1,7], info="Not sorted correctly")
    expect_equal("AGE", contributions[1,5], info="Not sorted correctly")
    expect_equal("PSA", contributions[1,3], info="Not sorted correctly")
    expect_equal("GLEASON", contributions[1,1], info="Not sorted correctly")
}
...
checkSortedCorrectlyAbs <- function (contributions) {
    ...
    expect_equal("GLEASON", contributions[1,1], info="Not sorted correctly")
    expect_equal("PSA", contributions[1,3], info="Not sorted correctly")
    expect_equal("VOL", contributions[1,5], info="Not sorted correctly")
    expect_equal("AGE", contributions[1,7], info="Not sorted correctly")
    expect_equal("DPROS", contributions[1,9], info="Not sorted correctly")
    expect_equal("DCAPS", contributions[1,11], info="Not sorted correctly")
    expect_equal("RACE", contributions[1,13], info="Not sorted correctly")
}
...
checkSortedCorrectlyReverseAbs <- function (contributions) {
    ...
    expect_equal("GLEASON", contributions[1,13], info="Not sorted correctly")
    expect_equal("PSA", contributions[1,11], info="Not sorted correctly")
    expect_equal("VOL", contributions[1,9], info="Not sorted correctly")
    expect_equal("AGE", contributions[1,7], info="Not sorted correctly")
    expect_equal("DPROS", contributions[1,5], info="Not sorted correctly")
    expect_equal("DCAPS", contributions[1,3], info="Not sorted correctly")
    expect_equal("RACE", contributions[1,1], info="Not sorted correctly")
}
