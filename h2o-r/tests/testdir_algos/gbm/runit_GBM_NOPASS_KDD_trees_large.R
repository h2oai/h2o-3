...
check.test_KDD_trees <- function(conn){
    ...
    test1 <- h2o.gbm(x = 1:len, y = 'TARGET_D', training_frame =  cup98Train, ntrees = 2, max_depth = 8)
    test2 <- h2o.gbm(x = 1:len, y = 'TARGET_D', training_frame =  cup98Train, ntrees = 2, max_depth = 8)
