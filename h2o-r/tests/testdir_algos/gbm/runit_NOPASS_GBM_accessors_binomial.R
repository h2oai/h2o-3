...
test.gbm.bin.accessors <- function(conn) {
  ...
  print(mse.basic)
  expect_error(h2o.mse(pros.gbm, valid = TRUE))
  ...
  print(r2.basic)
  expect_error(h2o.r2(pros.gbm, valid = TRUE))
  ...
  print(ll.basic)
  expect_error(h2o.logloss(pros.gbm, valid = TRUE))
  ...
  print(auc.basic)
  expect_error(h2o.auc(pros.gbm, valid = TRUE))
  ...
  print(gini.basic)
  expect_error(h2o.giniCoef(pros.gbm, valid = TRUE))
