...
test.glm.bin.accessors <- function(conn) {
  ...
  pros.glm.valid <- h2o.glm(x = 3:9, y = 2, training_frame = pros.train, validation_frame = pros.test, family = "binomial")

  Log.info("MSE...")
  mse.basic <- h2o.mse(pros.glm)
  print(mse.basic)
  expect_error(h2o.mse(pros.glm, valid = TRUE))
  ...
  print(r2.basic)
  expect_error(h2o.r2(pros.glm, valid = TRUE))
  ...
  print(ll.basic)
  expect_error(h2o.logloss(pros.glm, valid = TRUE))
  ...
  print(auc.basic)
  expect_error(h2o.auc(pros.glm, valid = TRUE))
  ...
  print(gini.basic)
  expect_error(h2o.giniCoef(pros.glm, valid = TRUE))
  ...
  print(nuldev.basic)
  expect_error(h2o.nullDev(pros.glm, valid = TRUE))
  ...
  print(resdev.basic)
  expect_error(h2o.resDev(pros.glm, valid = TRUE))
  ...
  print(aic.basic)
  expect_error(h2o.aic(pros.glm, valid = TRUE))
  ...
  print(dof.basic)
  expect_error(h2o.dof(pros.glm, valid = TRUE))
  ...
  print(nulldof.basic)
  expect_error(h2o.nullDof(pros.glm, valid = TRUE))
