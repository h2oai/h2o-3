...
test.linkFunctions <- function(conn) {
	...
	deviance.h2o.logit <- model.h2o.binomial.logit@model$training_metrics$residual_deviance / model.h2o.binomial.logit@model$training_metrics$null_deviance
	deviance.R.logit <- deviance(model.R.binomial.logit)  / model.h2o.binomial.logit@model$training_metrics$null_deviance
