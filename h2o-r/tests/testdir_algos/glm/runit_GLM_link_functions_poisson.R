...
test.linkFunctions <- function(conn) {
	...
	deviance.h2o.log = model.h2o.poisson.log@model$training_metrics$residual_deviance / model.h2o.poisson.log@model$training_metrics$null_deviance
	deviance.R.log = deviance(model.R.poisson.log)  / model.h2o.poisson.log@model$training_metrics$null_deviance
	...
	deviance.h2o.identity = model.h2o.poisson.identity@model$training_metrics$residual_deviance / model.h2o.poisson.identity@model$training_metrics$null_deviance
	deviance.R.identity = deviance(model.R.poisson.identity)  / model.h2o.poisson.identity@model$training_metrics$null_deviance
