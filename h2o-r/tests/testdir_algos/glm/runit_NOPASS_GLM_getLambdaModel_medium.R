...
my.glm = h2o.glm(x=myX, y=myY, training_frame=pros.hex, family=family, standardize=T, use_all_factor_levels=TRUE, lambda_search=T, return_all_lambda=T, variable_importances=TRUE)
