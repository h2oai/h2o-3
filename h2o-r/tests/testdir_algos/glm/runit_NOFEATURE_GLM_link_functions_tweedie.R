...
test.linkFunctions <- function(conn) {
	...
	model.h2o.tweedie.tweedie <- h2o.glm(x=myX, y=myY, training_frame=h2o.data, family="tweedie", link="tweedie",alpha=0.5, lambda=0, nfolds=0)
	...
	deviance.h2o.tweedie = model.h2o.tweedie.tweedie@model$training_metrics$residual_deviance / model.h2o.tweedie.tweedie@model$training_metrics$null_deviance
	deviance.R.tweedie = deviance(model.R.tweedie.tweedie)  / model.h2o.tweedie.tweedie@model$training_metrics$null_deviance
