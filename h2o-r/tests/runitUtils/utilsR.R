...
compare_weighted_stats <- function(model, dataframe, xlist, xname, weight_vector, target_index) {
  weightStats = manual_partial_dependency(model, dataframe, xlist, xname, weight_vector, target_index) 
