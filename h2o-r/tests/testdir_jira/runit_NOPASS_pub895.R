...
spect_header = h2o.importFile(conn,normalizePath(locate("smalldata/jira/SPECT_header.txt")),key = "spect_header")
print("Parse train and test files")
spect_train = h2o.importFile(conn,normalizePath(locate("smalldata/jira/SPECT_train.txt")),key = "spect_train",col.names=spect_header)
spect_test = h2o.importFile(conn,normalizePath(locate("smalldata/jira/SPECT_test.txt")),key = "spect_test", col.names=spect_header)
