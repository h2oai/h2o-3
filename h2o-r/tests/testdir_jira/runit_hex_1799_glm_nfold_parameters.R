...
function() {
  ...
  h2oTest.logInfo("Expect that the xval model has a family binomial, just like the main model...")
  ...
  h2oTest.logInfo("Expect that the xval model has standardize set to FALSE as it is in the main model.")
...
h2oTest.doTest("Perform the test for hex 1799", hex_1799_test)
