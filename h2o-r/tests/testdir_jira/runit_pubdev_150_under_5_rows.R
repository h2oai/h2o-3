...
test_one_file <- function(fnam, mins, maxs) {
  ...
  raw_payload = .h2o.doSafeREST(urlSuffix = paste0("H2OFrames.json/",fnam,".hex/columns/B/summary"), method = "GET")
  # print(raw_payload)
  json = .h2o.fromJSON(jsonlite::fromJSON(raw_payload,simplifyDataH2OFrame=FALSE))
