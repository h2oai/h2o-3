...
expect_warning(h2o.glm(x = c(1:4,6:8), y = "class_REC", data = iris.hex, family = "binomial", lambda = 0))
expect_warning(h2o.glm(x = c(1:4,6:8), y = "class_REC", data = iris.hex, family = "binomial", lambda = c(0,1e-5,0.1)))
