...
myY <- 1
my.glm <- h2o.glm(x=myX, y=myY, training_frame=spect_train, family="binomial", standardize=T, use_all_factor_levels=TRUE, lambda_search=T, return_all_lambda=T, variable_importances=TRUE)
print(my.glm)
