...
test.pubdev.1692 <- function() {
  ...
  init <- msq.dat[1:k,]
  fitH2O <- h2o.glrm(msq.hex, k = k, transform = "NONE", init = "User", user_y = init, loss = "Quadratic", gamma_x = 0, gamma_y = 0, max_iterations = 1000)
  ...
  fitH2O_dm <- h2o.glrm(msq.hex, k = k, transform = "DEMEAN", init = "User", user_y = init, loss = "Quadratic", gamma_x = 0, gamma_y = 0, max_iterations = 1000)
  ...
  fitH2O_scale <- h2o.glrm(msq.hex, k = k, transform = "STANDARDIZE", init = "User", user_y = init, loss = "Quadratic", gamma_x = 0, gamma_y = 0, max_iterations = 1000)
