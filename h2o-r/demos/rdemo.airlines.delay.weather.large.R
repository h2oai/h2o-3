...
pathToWeatherData <- h2o:::.h2o.locate("smalldata/chicago/Chicago_Ohare_International_Airport.csv")
...
# weather.hex$Date <- as.Date(weather.hex$Date, format = "%m/%d/%Y") # As of 5/29/2016 H2O now parses as a date
