...
print("Import and parse walking gait data...")
gait.hex <- h2o.importFile(locate_source("smalldata/glrm_test/subject01_walk1.csv"), destination_frame = "gait.hex")
print(summary(gait.hex))

print("Basic GLRM using quadratic loss and no regularization (PCA)")
...
print("Import and parse walking gait data with missing values...")
gait.miss <- h2o.importFile(locate_source("smalldata/glrm_test/subject01_walk1_miss15.csv"), destination_frame = "gait.miss")
