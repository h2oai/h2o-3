...
public class MySQL {
	...
	public static boolean save(String metricType, String result, HashMap<String, String> rawInput) {
		...
		String sql = String.format(
				...
				config.getTableName(), testcaseId, trainingFrameId, validationFrameId, metricType, result, currentTime,
