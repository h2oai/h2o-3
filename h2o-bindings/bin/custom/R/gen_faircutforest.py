...
model <- h2o.fairCutForest(x = predictors,
                                     training_frame = p,
                                     model_id = "fcf.hex",
                                     ntrees = 100,
                                     sample_size = 256,
...
# Number in [0, 1] explicitly defined in paragraph '2 Isolation and Isolation Trees' of Isolation Forest paper
anomaly_score <- score$anomaly_score
