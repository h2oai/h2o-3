    ...
    for param in schema["parameters"]:
        ...
        if param["name"] == "seed":
            if algo != "stackedensemble":
                ...
                yield "#'        The type is long, however, R cannot handle long number correctly, so the type can also be a string."
                yield "#'        For example autogenerated seed -8664354335142703762 has to be passed as string \"-8664354335142703762\")."
            else:
