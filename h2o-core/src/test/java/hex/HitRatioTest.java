...
public class HitRatioTest {
  ...
  public void testHits() {
    ...
    // top-2 or top-3
    Arrays.fill(hits, 0);
    actual_label = 1; pred_dist = new double[]{2,.3f,.3f,.35f,.05f}; updateHits(actual_label, pred_dist, hits);
    Assert.assertTrue(
        Arrays.equals(hits, new long[]{0, 1, 0, 0}) ||
    ...
    // 3 Ties
    Arrays.fill(hits, 0);
    actual_label = 1; pred_dist = new double[]{3,.3f,.3f,.1f,.3f}; updateHits(actual_label, pred_dist, hits);
    Assert.assertTrue(
    ...
    Arrays.fill(hits, 0);
    actual_label = 1; pred_dist = new double[]{3,.1f,.1f,.1f,.7f}; updateHits(actual_label, pred_dist, hits);
    Assert.assertTrue(
        Arrays.equals(hits, new long[]{0, 1, 0, 0}) ||
            Arrays.equals(hits, new long[]{0, 0, 1, 0}) ||
            Arrays.equals(hits, new long[]{0, 0, 0, 1})
    ...
    Arrays.fill(hits, 0);
    actual_label = 2; pred_dist = new double[]{3,.1f,.1f,.1f,.7f}; updateHits(actual_label, pred_dist, hits);
    Assert.assertTrue(
        Arrays.equals(hits, new long[]{0, 1, 0, 0}) ||
            Arrays.equals(hits, new long[]{0, 0, 1, 0}) ||
            Arrays.equals(hits, new long[]{0, 0, 0, 1})
    ...
    // 4 Ties
    Arrays.fill(hits, 0);
    actual_label = 1; pred_dist = new double[]{2,.25f,.25f,.25f,.25f}; updateHits(actual_label, pred_dist, hits);
    Assert.assertTrue(
        Arrays.equals(hits, new long[]{1, 0, 0, 0}) ||
            Arrays.equals(hits, new long[]{0, 1, 0, 0}) ||
            Arrays.equals(hits, new long[]{0, 0, 1, 0}) ||
    ...
    Arrays.fill(hits, 0);
    actual_label = 1; pred_dist = new double[]{4,.15,0.1,0.1,.25,.3,.15,0.2,0.2}; updateHits(actual_label, pred_dist, hits);
    Assert.assertTrue(
    ...
    Arrays.fill(hits, 0);
    actual_label = 6; pred_dist = new double[]{4,.15,0.1,0.1,.25,.3,.15,0.2,0.2}; updateHits(actual_label, pred_dist, hits);
    Assert.assertTrue(
        Arrays.equals(hits, new long[]{0, 0, 1, 0}) ||
            Arrays.equals(hits, new long[]{0, 0, 0, 1})
    );
