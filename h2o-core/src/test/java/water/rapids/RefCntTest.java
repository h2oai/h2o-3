...
public class RefCntTest extends TestUtil {
  ...
  public void testBasic() {
    ...
    session.exec("(tmp= py_1 (:= chicagoCrimes10k.hex (as.Date (cols_py chicagoCrimes10k.hex \"Date\") \"%m/%d/%Y %I:%M:%S %p\") 2 []))");
    ...
    session.exec("(rm chicagoCrimes10k.hex)"); crimes = null;
    ...
    session.exec("(tmp= py_3 (append py_2 (month (cols_py py_2 \"Date\")) \"Month\"))");
    ...
    // instead of append.
    session.exec("(, (rm py_2) (tmp= py_4 (:= py_3 (+ (year (cols_py py_3 \"Date\")) 1900) 17 [])))");
    ...
    session.exec("(, (rm py_3) (tmp= py_5 (append py_4 (week (cols_py py_4 \"Date\")) \"WeekNum\")))");
    ...
    session.exec("(,  (rm py_4) (tmp= py_6 (append py_5 (dayOfWeek (cols_py py_5 \"Date\")) \"WeekDay\")))");
    ...
    session.exec("(, (rm py_5) (tmp= py_7 (append py_6 (hour (cols_py py_6 \"Date\")) \"HourOfDay\")))");
    ...
    session.exec("(, (rm py_6) (tmp= py_8 (append py_7 (| (== (cols_py py_7 \"WeekDay\") \"Sun\") (== (cols_py py_7 \"WeekDay\") \"Sat\")) \"Weekend\")))");
    ...
    // A more involved expression; lots of internal temps
    session.exec("(, (rm py_7) (tmp= py_9 (append py_8 (cut (cols_py py_8 \"Month\") [0 2 5 7 10 12] [\"Winter\" \"Spring\" \"Summer\" \"Autumn\" \"Winter\"] FALSE TRUE 3) \"Season\")))");
    ...
    // Drop a column
    session.exec("(, (rm py_8) (tmp= py_10 (cols py_9 -3)))");
