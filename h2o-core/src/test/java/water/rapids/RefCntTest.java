...
public class RefCntTest extends TestUtil {
  ...
  public void testBasic() {
    ...
    // that this removeVecs is only valid when done in the session context -
    ...
    for( VecAry vec : py_1.vecs().singleVecs() ) vec.mean(); // Verify we can compute rollups on all cols; will crash if some cols are deleted
    ...
    for( VecAry vec : py_2.vecs().singleVecs() ) vec.mean(); // Verify we can compute rollups on all cols; will crash if some cols are deleted
    ...
    for( VecAry vec : py_3.vecs().singleVecs() ) vec.mean(); // Verify we can compute rollups on all cols; will crash if some cols are deleted
    ...
    for( VecAry vec : py_4.vecs().singleVecs() ) vec.mean(); // Verify we can compute rollups on all cols; will crash if some cols are deleted
    ...
    for( VecAry vec : py_5.vecs().singleVecs() ) vec.mean(); // Verify we can compute rollups on all cols; will crash if some cols are deleted
    ...
    for( VecAry vec : py_6.vecs().singleVecs() ) vec.mean(); // Verify we can compute rollups on all cols; will crash if some cols are deleted
    ...
    for( VecAry vec : py_7.vecs().singleVecs() ) vec.mean(); // Verify we can compute rollups on all cols; will crash if some cols are deleted
    ...
    for( VecAry vec : py_8.vecs().singleVecs() ) vec.mean(); // Verify we can compute rollups on all cols; will crash if some cols are deleted
    ...
    for( VecAry vec : py_9.vecs().singleVecs() ) vec.mean(); // Verify we can compute rollups on all cols; will crash if some cols are deleted
    ...
    for( VecAry vec : py_10.vecs().singleVecs() ) vec.mean(); // Verify we can compute rollups on all cols; will crash if some cols are deleted
