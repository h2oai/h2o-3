...
//  }
//
//  static AST test1_json() {
////    JsonParser parser = new JsonParser();
//    String s = "(+ (ID Last.value.0) (# 5))"; //"{\"astop\":{\"type\":\"BinaryOperator\",\"operator\":\"+\",\"infix\":true,\"node_type\":\"ASTOp\",\"operands\":{\"left\":{\"type\":\"Frame\",\"value\":\"Last.value.0\",\"node_type\":\"ASTFrame\"},\"right\":{\"type\":\"Numeric\",\"value\":5,\"node_type\":\"ASTNumeric\"}}}}";
//    return (new Exec(s)).parse();//(JsonObject)parser.parse(s);
//  }
//
//  //  static ASTTree
