...
public class LogTest {
  ...
  public void testIsLoggingEnabledFor(){
    ...
    Assert.assertFalse(Log.isLoggingEnabledFor(Log.Level.TRACE));
    Assert.assertTrue(Log.isLoggingEnabledFor(Log.Level.INFO));
    Assert.assertTrue(Log.isLoggingEnabledFor(Log.Level.WARN));
  }
