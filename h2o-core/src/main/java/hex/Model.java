...
public abstract class Model<M extends Model<M,P,O>, P extends Model.Parameters, O extends Model.Output> extends Lockable<M> {
  ...
  public abstract static class Parameters extends Iced {
    ...
    public Key _train;               // Frame the Model is trained on
    public Key _valid;               // Frame the Model is validated on, if any
    ...
    private transient Frame _tfr;    // Training   frame cache
    ...
    /** Read-UnLock both training and validation frames. */
    ...
    public long checksum() {
      ...
      return (field_checksum == 0 ? 13 : field_checksum) *
        _train.get().checksum() *
        (_valid == null ? 17 : _valid.get().checksum()) *
