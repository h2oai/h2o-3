...
public interface MetalearnerHyperSpaceWalker<MP extends Model.Parameters, C extends HyperSpaceSearchCriteria> {

    interface MetalearnerHyperSpaceIterator<MP extends Model.Parameters> {
        /**
    ...
    } // interface MetalearnerHyperSpaceIterator
     ...
     * @return an iterator
     */
    MetalearnerHyperSpaceIterator<MP> iterator();
    ...
    public static class CartesianMetaLearnerWalker<MP extends Model.Parameters>
        ...
        public MetalearnerHyperSpaceIterator<MP> iterator() {
            ...
            }; // anonymous MetalearnerHyperSpaceIterator class
        } // iterator()
