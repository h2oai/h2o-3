...
public class SubsetChunk extends Chunk {
  ...
  public static AutoBuffer write_impl(SubsetVec.SubsetChunk sc, AutoBuffer bb) { throw water.H2O.fail(); }
  @Override public final SubsetChunk read_impl(AutoBuffer bb) { throw water.H2O.fail(); }
}
