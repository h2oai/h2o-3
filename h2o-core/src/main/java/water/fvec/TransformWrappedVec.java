...
public class TransformWrappedVec extends WrappedVec {
  ...
  private final AstFunction _fun;

  public TransformWrappedVec(Key key, int rowLayout, AstFunction fun, Key<Vec>... masterVecKeys) {
  ...
  public TransformWrappedVec(Vec v, AstFunction fun) {
