...
public class Icer<T extends Freezable> { 
  ...
  protected AutoBuffer writeHTML(AutoBuffer ab, T ice) { /*base of the write call chain; no fields to write*/return ab; }
  ...
  protected final AutoBuffer writeHTML2(AutoBuffer ab, T ice) { return ab; }
  ...
  protected final AutoBuffer writeHTML3(AutoBuffer ab, T ice) { return ab; }
