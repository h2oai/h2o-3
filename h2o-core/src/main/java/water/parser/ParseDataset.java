            ...
            public void compute2() {
              ...
              while (ti < tLen && oi < oLen) {
                ...
                if (x <= 0) {
                  ...
                  assert tDomLen >= 0 : getClass().getSimpleName() + ".reduce/1: tDomLen=" + tDomLen + ", tbi=" + tbi;
                  tbi += 4;
                  ...
                  if (x == 0) { // this == other
                    ...
                    obi += 4;
                    assert oDomLen >= 0 : getClass().getSimpleName() + ".reduce/2: oDomLen=" + oDomLen + ", obi=" + obi;
                  ...
                  oDomLen = UnsafeUtils.get4(otherDom, obi);
                  obi += 4;
                  assert oDomLen >= 0 : getClass().getSimpleName() + ".reduce/3: oDomLen=" + oDomLen + ", obi=" + obi;
                  oCat.set(otherDom, obi, oDomLen);
                  oi++;
                }
                mergeLen++;
