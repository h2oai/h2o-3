...
class XlsParser extends Parser {
  ...
  public static ParseSetupHandler guessSetup( byte[] bytes ) {
    XlsParser p = new XlsParser(new ParseSetupHandler(true, 0, null, ParserType.XLS, ParseSetupHandler.AUTO_SEP, -1, false, null, null));
    ...
    return new ParseSetupHandler(dout._ncols > 0 && dout._nlines > 0 && dout._nlines > dout._invalidLines,
                                 dout._invalidLines, dout.errors(), ParserType.XLS, ParseSetupHandler.AUTO_SEP, dout._ncols,false,dout.colNames(), dout._data);
  }
