...
abstract public class ModelMetricsBinomialBaseV3<I extends ModelMetricsBinomial, S extends ModelMetricsBinomialBaseV3<I, S>> extends ModelMetricsBase<I, S> {
  ...
  @Override
    ...
    if (null != modelMetrics._auc) {
      //// Fill AUC
      //this.AUC = modelMetrics._auc.AUC;
      //
      //// Fill Gini
      //this.Gini = modelMetrics._auc.Gini;
      //
      ...
      //int numThresholds = modelMetrics._auc.thresholds.length;
      //String[] thresholds = new String[numThresholds];
      //for(int i=0; i<numThresholds; i++){
      //  thresholds[i] = Float.toString(modelMetrics._auc.thresholds[i]);
      //}
