...
public class RequestServer extends NanoHTTPD {
  ...
  static {
    ...
    register("/3/ModelBuilders/visibility/(?<level>.*)"          ,"POST"  ,ModelBuildersHandler.class, "setVisibility",               new String[] {"level"},
      "Set Model Builders visibility level.");
    register("/3/ModelBuilders/visibility"                       ,"GET"   ,ModelBuildersHandler.class, "getVisibility",
