...
public class TCPReceiverThread extends Thread {
    ...
    public void run() {
      while( true ) { // Loop, reading fresh TCP requests until the sender closes
        try {
          ...
          System.out.println("_last_heard_from (4): " + _ab._h2o._key.getIpPortString() + " = " + _ab._h2o._last_heard_from);
  ...
  static class UDP_TCP_ReaderThread extends Thread {
    ...
    @Override public void run() {
      ...
      try {
        ...
        while (true) {
          System.out.println(System.currentTimeMillis() + "; Waiting for a message from " + _h2o + ":" + getName());
          ...
          System.out.println(System.currentTimeMillis() + "; Receiving a message of size " + sz + "B from " + _h2o + ":" + getName());
          idle = false;
  ...
  static public void basic_packet_handling( AutoBuffer ab ) throws java.io.IOException {
    ...
    System.out.println("_last_heard_from (6): " + ab._h2o._key.getIpPortString() + " = " + ab._h2o._last_heard_from + " | " + ab._h2o.debugInfo() + "; currentTimeMillis = " + System.currentTimeMillis());
