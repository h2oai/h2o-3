...
public final class AutoBuffer {
  ...
  private void checkVersion(String version) {
    ...
    if (! version.equals(H2O.ABV.projectVersion())) {
      final String msg = H2O.technote(14,"Found version "+version+", but running version "+H2O.ABV.projectVersion() );
      if (ignoreVersion)
...
//    TimeLine.record_IOclose(this,_persist); // Profile AutoBuffer connections
  ...
  // Same port extraction is done in portPack method on TimelineSnapshot. If getPort method is changed,
  // there is a big change portPack needs to be changed as well te consistent
