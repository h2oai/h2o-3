...
public class CBSChunk extends Chunk {
  ...
  @Override final protected AutoBuffer write_impl(AutoBuffer bb) { return bb.putA1(_mem, _mem.length); }
  @Override final protected CBSChunk read_impl(AutoBuffer bb) {
    _mem   = bb.bufClose();
    _start = -1;
    _gap   = _mem[0];
    _bpv   = _mem[1];
