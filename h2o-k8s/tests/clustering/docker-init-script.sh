...
k3d --version
k3d delete
k3d create -v $H2O_BASE/build/h2o.jar:/h2o/h2o.jar --registries-file registries.yaml --publish 8080:80 --api-port localhost:6444 --server-arg --tls-san="127.0.0.1" --wait 120 
