...
parser = argparse.ArgumentParser(
    description='Attach to an H2O instance and call its REST API to generate the CSharp REST API bindings docs and write them to the filesystem.',
)
...
parser.add_argument('--dest', help='destination directory', default=(here + '/../build/src-gen/main/CSharp'))
...
for schema in all_schemas:
    ...
    save_full = args.dest + os.sep + 'water/bindings/pojos/' + pojo_name + '.cs'
