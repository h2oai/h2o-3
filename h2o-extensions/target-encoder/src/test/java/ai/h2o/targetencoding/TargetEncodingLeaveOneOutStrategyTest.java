...
public class TargetEncodingLeaveOneOutStrategyTest extends TestUtil {
  ...
  public void calculateAndAppendBlendedTEEncodingDivisionByZeroTest() {
    ...
    try {
      ...
      tec.applyEncodings(reimportedFrame, targetColumnName, priorMean, TargetEncoder.DEFAULT_BLENDING_PARAMS);
  ...
  public void naValuesWithLOOStrategyTest() {
    ...
    try {
      ...
      Frame resultWithEncodings = tec.applyTargetEncoding(
              fr,
              targetColumnName,
              targetEncodingMap,
              TargetEncoder.DataLeakageHandlingStrategy.LeaveOneOut,
  ...
  public void comparisonBetweenNAsAndNonEmptyStringForLOOStrategyTest() {
    ...
    try {
      ...
      Frame resultWithEncoding2 = tec.applyTargetEncoding(
              fr2,
              targetColumnName,
              targetEncodingMap2,
              TargetEncoder.DataLeakageHandlingStrategy.LeaveOneOut,
  ...
  public void comparisonBetweenEmptyStringAndNonEmptyStringForLOOStrategyTest() {
    ...
    Frame resultWithEncoding = tec.applyTargetEncoding(fr,
            targetColumnName,
            targetEncodingMap,
            TargetEncoder.DataLeakageHandlingStrategy.LeaveOneOut,
            null,
  ...
  public void LOOHoldoutMultipleTEColumnsWithFoldColumnTest() {
    ...
    Frame resultWithEncodingForColumn1 = tecA.applyTargetEncoding(
            frA,
            targetColumnName,
            targetEncodingMapForColumn1,
            TargetEncoder.DataLeakageHandlingStrategy.LeaveOneOut,
            foldColumnName,
            null,
            0,
    ...
    Frame resultWithEncodingForColumn2 = tecB.applyTargetEncoding(
            frB,
            targetColumnName,
            targetEncodingMapForColumn2,
            TargetEncoder.DataLeakageHandlingStrategy.LeaveOneOut,
            foldColumnName,
            null,
            0,
