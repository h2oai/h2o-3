...
import hex.tree.gbm.GBMPredictContribsTest;
...
public class XGBoostTest extends TestUtil {
  ...
  private static DMatrix[] getMatrices() throws XGBoostError {
  ...
  @Test public void testExtendedFeatureScore() throws XGBoostError {
    Map<String, String> rabitEnv = new HashMap<>();
    rabitEnv.put("DMLC_TASK_ID", "0");
    Rabit.init(rabitEnv);
    // load file from text file, also binary buffer generated by xgboost4j
  ...
  private Map<String, XGBoostUtils.FeatureScore> getExtFeatureScore(Booster booster) throws XGBoostError {
    String[] modelDump = booster.getModelDump(null, true);
